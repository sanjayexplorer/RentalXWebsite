...
class LeadsController extends Controller{
    ...
    public function list()
    {
        // echo "leads list";
        // die;
        // $users = leads::where('id', '!=', auth()->user()->id)
        ...
        return view('agent.leads.list', compact('leads'));
        ...
        foreach ($leads as $lead) {
            ...
            $arrData[] = [
                ...
                'action' => [
                    ...
                    'view_url' => route('agent.leads.view', $lead->id),
                    'status_change_url'=>route('agent.leads.status.update',$lead->id)
                ],
            ];
        }
        $response = [
    ...
    public function addPost(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'pick_up_date_time' =>'required ',
                    // Rule::unique('cars', 'registration_number')->where(function ($query) {
                    //     $query->where('status', 'NOT LIKE', 'deleted');
                    // }),
        ...
        return redirect()->route('agent.leads.list')->with('success', 'Car has been added');
    ...
    public function view(Request $request ,$id)
    {
       if($id)
       {
            ...
            return view('agent.leads.view',compact('leads'));
        
       }
       else
       {

        return redirect()->route('agent.leads.list')->with('error', 'invalid id ');
