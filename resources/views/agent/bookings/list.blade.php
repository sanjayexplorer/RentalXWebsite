...
<style>
    ...
    .drop_down_fillter_2{ border:1px solid #d7d7d7; }
                ...
                <div class="booking_head_sec">
                    <div class="flex items-center mb-[36px] lg:mb-[20px]">
                            <div class="flex items-center justify-start w-1/2">
                                ...
                                <span class="inline-block text-black800 text-[26px] md:text-xl font-normal leading-normal align-middle">Active Bookings</span>
                            </div>
                         ...
                         <div class="flex xl:basis-[65%] basis-[70%] align-center 2xl:grow-0 2xl:shrink-0 m-0">
                                    <div class="basis-[35%]  xl:basis-[57%] 3xl:basis-[45%] pr-2">
                                        <div class="w-auto">
                                            ...
                                            <input type="text" class="w-full inline-block text-xm text-sm placeholder-[#CCCCCC]  bg-[#F4F4F4] appearance-none leading-4 outline-none rounded text-black  rounded bg-[#F4F4F4] py-3 pr-[44px] pl-3" id="search_listing"
                                    ...
                                    <div class="basis-[30%]  xl:basis-[40%] 3xl:basis-[35%] px-2">
                                        <div class="w-auto">
                                            ...
                                            <span class="absolute hidden top-[14px] right-[13px] cross_icon_date">
                                                ...
                                                <div class="drop_down_fillter_2 desk_daterange_filter absolute left-0 top-[58px] border-[#E0DCDC] fltr_dropdown_shadow  bg-[#FFFFFF] z-[2] min-w-[252px] w-full rounded-[5px] hidden">
                    ...
                    <div class="relative">
                        ...
                        <div class="bg-[#FFFFFF]">
                            <div class="w-full overflow-y-auto filter_height_sec">
                                <form action="{{route('agent.booking.list.filter')}}" id="mob_filters_form" method="post"
                                                    ...
                                                    <div class="py-[10px] ">
                                                        <div class="flex mobile_filter_box_tittle px-[15px] ">
                                                            ...
                                                            <div class="flex justify-end w-1/2 font-normal mobile_filter_right_sec">
                                                                <div>
                                                                    <a href="javascript:void(0);"  class="text-sm font-normal segment_choices_clear reset_btn capitalize text-[#F4B20F] p-2 ">
                                                                        reset
                                                                    </a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="py-[10px] px-[15px]">
                                                        <div class="flex mobile_filter_box_tittle ">
                                                            ...
                                                            <div class="flex justify-end w-1/2 font-normal mobile_filter_right_sec">
                                                                <div>
                                                                    <a href="javascript:void(0);"
                                                                        class="text-sm font-normal reset_mob_date capitalize text-[#F4B20F] p-2">
                                                                        reset
                                                                    </a>
                                                                </div>
                                                            </div>
                        ...
                        @foreach($booked_cars as $booked_car)
                            ...
                            <div class="mb-5 bookingLength">
                                <div class="booking_car_list_box p-4  rounded-[4px] md:hidden block
                                    ...
                                    @if(($currentTimeDate >= $pickupTimeBeforeThirty && strcmp($booked_car->status, 'delivered') !== 0 ) && (strcmp($booked_car->status, 'collected') !== 0))

                                        bg-[#fffbe5]
                                    @elseif(($currentTimeDate >= $dropoffTimeBeforeThirty && strcmp($booked_car->status, 'delivered') == 0) && (strcmp($booked_car->status, 'collected') !== 0))
                                        bg-[#fffbe5]
                                    @else
                                        bg-white
                                    @endif">
                                        ...
                                        <div class="list_cr_item">
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="flex items-center flex-wrap gap-[3px]">
                                                    ...
                                                    <!-- pickup  -->
                                                    @elseif(($pickupDaysGap == 0) && ($nowDateTimeObject <= $nowCarbonStartDateTime) && (strcmp($booked_car->status, 'collected') !== 0)  )
                                                        <div class="flex items-center justify-center mr-[32px] sm:mr-[10px] 3xl:mr-[25px]">
                                                            <div class="block">
                                                                    <img src="{{asset('images/time-clock-img.svg')}}" alt="clock" class="w-[19px]">
                                                            </div>
                                                        ...
                                                        @elseif(($pickupDaysGap == 1) && ($nowDateTimeObject <= $nowCarbonStartDateTime ) && (strcmp($booked_car->status, 'collected') !== 0) )
                                                            <div class="flex items-center justify-center mr-[32px] sm:mr-[10px] 3xl:mr-[25px]">
                                                                <div class="block">
                                                                    <img src="{{asset('images/time-clock-img.svg')}}" alt="clock" class="w-[19px]">
                                                                </div>
                                                    ...
                                                    <!-- drop-off -->
                                                    @elseif(($dropDaysGap == 0) && ($nowDateTimeObject <= $nowCarbonEndDateTime) && (strcmp($booked_car->status, 'collected') !== 0)  )
                                                            <div class="flex items-center justify-center mr-[32px] sm:mr-[10px] 3xl:mr-[25px]">
                                                                <div class="block">
                                                                    <img src="{{asset('images/time-clock-img.svg')}}" alt="clock" class="w-[19px]">
                                                                </div>
                                                    ...
                                                    @elseif(($dropDaysGap == 1) && ($nowDateTimeObject <= $nowCarbonEndDateTime) && (strcmp($booked_car->status, 'collected') !== 0))
                                                        ...
                                                        @elseif(($pickupDaysGap>1) && (strcmp($booked_car->status, 'collected') !== 0))
                                            ...
                                            <div class="flex flex-wrap  booking_list_card_bottom_section mt-[9px]">
                                                ...
                                                <div class="ctc_info_w">
                                                    ...
                                                    <div class="block">
                                                        <a href="{{route('agent.booking.view',$booked_car->id)}}" class="links_item_cta inline-block text-[#2B2B2B] font-medium pb-[1px] leading-4 text-[13px] border-b-2 border-siteYellow">View Booking</a>
                                                    </div>
                        ...
                        ">
                            ...
                            <div class="mt-[18px] sm:mt-[12px] afclr">
                                ...
                                <div class="block mt-[2px]">
                                    <a href="{{route('agent.booking.view',$booked_car->id)}}" class="links_item_cta inline-flex items-center
                            ...
                            @if( (($currentTimeDate >= $pickupTimeBeforeThirty && strcmp($booked_car->status, 'delivered') !== 0) && (strcmp($booked_car->status, 'collected') !== 0) ) ||
                            (($currentTimeDate >= $dropoffTimeBeforeThirty && strcmp($booked_car->status, 'delivered') == 0)
                            && (strcmp($booked_car->status, 'collected') !== 0) ) )
...
/////////////////////////////////////////////// LOAD MORE //////////////////////////////////////////////
    ...
    function loadMoreCars(a)
    {
        ...
        $.ajax({
            url: '{{ route('agent.loadMoreBookings') }}',
            type: 'GET',
            data: {
                offset: offset,
    ...
    $('#mob_fltr_apply_btn').on('click',function(e){
        ...
        if ((mobile_fltr_start_date !== '') || (mobile_fltr_end_date !== ''))
        {
            ...
            $.ajax({
            url:"{{route('agent.booking.list.filter')}}",
            type: 'POST',
            data:{
                    '_token':'{{ csrf_token() }}',
    ...
    $('.choice_checkBox').on('click', function() {
        ...
        $.ajax({
                url: "{{ route('agent.searchCustomerAndMob') }}",
                type: 'GET',
                dataType: 'json',
                data: {
                    '_token': '{{ csrf_token() }}',
    ...
    $("#search_listing").autocomplete({
        source: function (request, response) {
            ...
            $.ajax({
                url: '{{ route('agent.autocompleteCustomerAndMob') }}',
                type: 'GET',
                dataType: "json",
                data: {
                    search: request.term
...
/////////////////////////////////////////  FOR POPUP REMOVE  /////////////////////////////////////////
    ...
    // Function to hide loader and overlay
        ...
        $('#newBookingCta').on('click', function(e) {
            ...
            // console.log('under newBookingCta');
    ...
    $('body').on('click', '.booking_action_btn', function(e) {
        ...
        console.log("spinner1");
            ...
            $.ajax({
                url:"{{ route('agent.change.booking.status')}}",
                type: 'POST',
                data: {
                    '_token': '{{ csrf_token() }}',
                    'action': action,
...
$('body').on('click', '.search_booking_action_btn', function(e) {
    ...
    if(result.isConfirmed){
        ...
        $.ajax({
            url:"{{ route('agent.search.change.booking.status')}}",
            type: 'POST',
            data: {
                '_token': '{{ csrf_token() }}',
                'action': action,
