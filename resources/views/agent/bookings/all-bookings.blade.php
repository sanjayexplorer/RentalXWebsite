                ...
                <div class="booking_head_sec">
                    <div class="flex items-center mb-[36px] lg:mb-[20px]">
                            ...
                            <div class="w-1/2 text-right flex justify-end">
                                <a href="{{route('agent.booking.calendar')}}" id="newBookingCta"
                                    ...
                                    <div class="basis-[30%]  xl:basis-[40%] 3xl:basis-[35%] px-2">
                                        <div class="w-auto">
                                            <div class="cursor-pointer  dropdown_sec_drop dropdown__drop_fillter_btn2 relative py-2 pl-[18px] rounded pr-11 bg-[#F4F4F4] date_range_block 3xl:w-max min-w-[225px] xl:min-w-[170px]">
                                                ...
                                                {{-- <ul  class="drop_down_fillter_2 desk_daterange_filter absolute left-0 top-[58px] border-[#E0DCDC] fltr_dropdown_shadow  bg-[#FFFFFF] z-[2] min-w-[252px] w-full rounded-[5px] hidden" >
                    ...
                    <div class="relative">
                        ...
                        <div class="bg-[#FFFFFF]">
                            <div class="w-full overflow-y-auto filter_height_sec">
                                <form action="{{route('agent.all.booking.list.filter')}}" id="mob_filters_form" method="post"
                ...
                <div class="main_booking_section_inner">
                    ...
                    <div class="mobile_booking_list hidden md:block ">
                        ...
                        ">
                            ...
                            && (strcmp($booked_car->status, 'collected') !== 0) && (strcmp($booked_car->status, 'canceled') !== 0) ) )
...
// }
    ...
    function loadMoreCars(a)
    {
        ...
        $.ajax({
            url: '{{ route('agent.allLoadMoreBookings') }}',
            type: 'GET',
            data: {
                offset: offset,
    ...
    $('#mob_fltr_apply_btn').on('click',function(e){
        ...
        if ((mobile_fltr_start_date !== '') || (mobile_fltr_end_date !== ''))
        {
            ...
            $.ajax({
            url:"{{route('agent.all.booking.list.filter')}}",
            type: 'POST',
            data:{
                    '_token':'{{ csrf_token() }}',
    ...
    $('.choice_checkBox').on('click', function() {
        ...
        $.ajax({
                url: "{{ route('agent.allSearchCustomerAndMob') }}",
                type: 'GET',
                dataType: 'json',
                data: {
                    '_token': '{{ csrf_token() }}',
...
/////////////////////////////////////////  DESKTOP  /////////////////////////////////////////
    ...
    $("#search_listing").autocomplete({
        source: function (request, response) {
            ...
            $.ajax({
                url: '{{ route('agent.allAutocompleteCustomerAndMob') }}',
                type: 'GET',
                dataType: "json",
                data: {
                    search: request.term
    ...
    $('body').on('click', '.booking_action_btn', function(e) {
        ...
        if(result.isConfirmed){
            ...
            $.ajax({
                url:"{{ route('agent.all.change.booking.status')}}",
                type: 'POST',
                data: {
                    '_token': '{{ csrf_token() }}',
                    'action': action,
...
$('body').on('click', '.search_booking_action_btn', function(e) {
    ...
    if(result.isConfirmed){
        ...
        $.ajax({
            url:"{{ route('agent.all.search.change.booking.status')}}",
            type: 'POST',
            data: {
                '_token': '{{ csrf_token() }}',
                'action': action,
