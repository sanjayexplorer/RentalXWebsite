...
<div class="dashboard_ct_section">
    <div class="lg:flex hidden lg:bg-white lg:mb-[0px] lg:px-[17px] lg:py-[15px] mb-[20px] justify-start items-center">
        ...
        <div class="flex items-center justify-start w-1/2">
            <a href="{{route('agent.booking.calendar')}}" class="inline-block p-2 mr-2 border border-[#C8C0C0] rounded-md
            hover:border-[#F3CD0E] active:border-[#000] active:bg-[#F3CD0E] GobackDelete">
                <img class="w-[15px]" src="{{ asset('images/short_arrow.svg') }}">
            </a>
            <span class="inline-block sm:text-base text-xl font-normal leading-normal align-middle text-black800">Edit date &
                    car</span>
        </div>
    ...
    <div class="pt-[42px] px-[36px] lg:px-[17px] lg:py-[20px] xl:py-10 bg-textGray400 pb-[100px]  min-h-screen lg:flex lg:justify-center">
        ...
        <div class="lg:hidden flex items-center mb-[36px] lg:mb-[20px] justify-between">
            ...
            {{-- <div class="flex items-center justify-start w-1/2">
                ...
                <span class="inline-block text-[26px] font-normal leading-normal align-middle text-black800">Create booking - customer details</span>
            </div> --}}
            <div class="lg:hidden flex flex-col">
                <div class="back-button">
                    <a href="{{route('agent.booking.calendar')}}" class="inline-flex py-1 px-2 border border-[#C8C0C0] rounded-md bg-[#fff] hover:border-[#F3CD0E] active:border-[#000] active:bg-[#F3CD0E] GobackDelete">
                        <img  class="w-[15px]" src="{{ asset('images/short_arrow.svg') }}">
        ...
        <div class="max-w-[768px] w-full bg-white lg:bg-[#F6F6F6] rounded-[10px] px-12 lg:px-[0px] py-9 lg:py-[0px]">
            ...
            <h4 class="inline-block text-black800 text-[26px] lg:text-[24px] md:text-xl font-normal leading-normal align-middle capitalize ">
                                ...
                                <div class="mt-[20px] md:mt-[5px] overflow-hidden form_outer">
                                    <div class="relative flex border border-[#898376] rounded-[10px] form_inner sm:bg-[#F6F6F6]">
                                        <div
                                            ...
                                            <h4
                                                class="sm:text-[13px] text-[14px] font-medium text-black500 mb-[5px] capitalize ">
                                                FROM</h4>
                                        <div class="block">
                ...
                <form action="{{route('agent.booking.add.post',$carId)}}" class="mt-5" id="formId" method="POST" onsubmit="return checkForm()">
                    @csrf
                    ...
                    <div class="pb-5">
                        ...
                        @endphp
                        <div class="flex flex-wrap -mx-3">
                            <input type="hidden" tabindex="-1"  id="number_of_days_default_value" value="{{$roundedDays}}">
                            <div class="w-full px-3 sm:w-full inp_container">
                            ...
                            <div class="w-full px-3 sm:w-full inp_container">
                                ...
                                <div class="rupee_price_field">
                                    <input type="text" tabindex="-1" name="agent_commission_received" id="agent_commission_received"
                                            class="w-full px-5 py-3 text-base font-normal leading-normal text-black
                                                bg-white border rounded-md  border-black500 focus:outline-none focus:border-siteYellow pl-[33px] commission_amount"
                                                placeholder="Enter agent commission received" value="">
                                        <span class="rupee_icon">₹</span>
                                    </div>
                            </div>
                        </div>
...
$('#discount').on('keyup input', function () {
    ...
    console.log('total booking amount:',parseFloat($('#total_booking_amount').val().replace(/,/g, '')));
    calculateAmountTotal();
});
...
$('.session_cta').on('click',function(e){
    ...
    $(".overlay_sections").css("display", "block");
    var calendarUrl = "{{ route('agent.booking.calendar') }}";
        e.preventDefault();
        var action_btn = $(this).data('action-btn');
          var start_date= $('#start_date').val();
            var end_date= $('#end_date').val();
            $.ajax({
                url: "{{ route('agent.booking.set.time') }}",
                method: "post",
                data: {
                    '_token': '{{ csrf_token() }}',
                    'action':action_btn,
