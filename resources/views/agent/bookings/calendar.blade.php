...
.scrollingContent { overscroll-behavior-inline: contain;}
...
.car_status_main_content { padding: 10px 10px 19px 0; } .toastify { display: flex; background: #ff0000; }
/* sticky styling */
.sticky_header { position: fixed; top: 0px; -webkit-transition: all .5s ease; -moz-transition: all .5s ease; transition: all .5s ease; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.19); }
/* .desktp_min_height{ min-height: 100vh; } .adj_empty_car_sec { height: calc(100vh - 250px); } */
.desktp_min_height { min-height: 100vh; }
.adj_empty_car_sec { height: calc(100vh - 250px); }
.dates_sec_sticky.scrollActive{top:60px;}
@media screen and (max-width: 992px) {
/* .desktp_min_height{ min-height: unset; } */
...
.adj_empty_car_sec { height: calc(100vh - 227px); } */
...
<div class="lg:flex hidden lg:bg-white lg:mb-[0px] lg:px-[17px] lg:py-[15px] mb-[20px] justify-start items-center">
    <div class="flex items-center justify-start w-full bg-white">
        <a href="{{route('agent.booking.list')}}" class="links_item_cta inline-block p-2 mr-2 border border-[#C8C0C0] rounded-md
        hover:border-[#F3CD0E] active:border-[#000] active:bg-[#F3CD0E]">
            <img class="w-[15px]" src="{{ asset('images/short_arrow.svg') }}">
        </a>
        <span class="inline-block text-xl font-normal leading-normal align-middle text-black800">Create Booking
        </span>
    </div>
</div>
...
<div class="right_dashboard_section_inner desktp_min_height py-9 px-9  lg:py-[20px] lg:px-[17px] bg-textGray400">
    ...
    <div class="lg:hidden flex items-center mb-[36px] lg:mb-[20px] justify-between">
        ...
        <div class="w-1/2 text-right">
            <a href="javascript:void(0);"
                class=" inline-block hover:bg-siteYellow400 transition-all duration-300 ease-out rounded-[4px] text-black text-base border border-siteYellow md:text-sm font-normal  bg-siteYellow px-[20px] py-2.5 md:px-[15px]">
                EXTERNAL BOOKING
            </a>
        </div>
    </div>
    ...
    <div class="w-1/2 text-right hidden lg:block">
        <a href="javascript:void(0);"
            class=" inline-flex rounded-[4px] items-center uppercase text-black text-base md:text-sm font-normal border border-siteYellow bg-siteYellow px-[20px] py-2.5 md:px-[15px] hover:bg-siteYellow400 lg:fixed sm:bottom-[80px] lg:bottom-[80px] z-10 lg:right-[18px] ">
            EXTERNAL BOOKING
        </a>
    </div>

    <!-- pb-[120px] 2xl:pb-[90px] lg:pb-[80px]  lg:pb-[100px] mx-auto -->
    <div class=" mx-auto main_sec sm:pb-5 bg-lightgray">
            ...
            <div class="">
                <div class=" w-full lg:px-[0px] lg:py-[0px]">
                    <div class="bg-white py-2.5 px-4 rounded mb-9 lg:hidden">
                        <form id="desktop_main_filter" action="{{route('agent.booking.calendar')}}">
                            <input type="hidden" name="start_date" class="desktop_start_date">
                            <input type="hidden" name="end_date" class="desktop_end_date">
                            <div class="flex flex-wrap align-center ">
                                <!-- 2xl:grow-0 2xl:shrink-0 2xl:mb-5 -->
                                <div
                                    class="flex basis-3/4 align-center 3xl:basis-full 3xl:mb-5 3xl:justify-center 3xl:grow-0 3xl:shrink-0    ">
                                   @php /* <div class="basis-[25%]  pr-2">
                                        <div class="w-auto">
                                            <div
                                                class="cursor-pointer  dropdown_sec_drop dropdown__drop_fillter_btn1 relative py-2 pl-[18px] rounded pr-11 bg-[#F4F4F4] date_range_block 3xl:w-max min-w-[225px]">
                                                <span class="absolute hidden top-[14px] right-[13px] cross_icon_date">
                                                    <img src="{{asset('images/cross.svg')}}"
                                                        alt="cross_icon_date" class="w-[14px]">
                                                </span>
                                                <a href="javascript:void(0);"
                                                ...
                                                <div
                                                    class="drop_down_fillter_1 desk_daterange_filter absolute left-0 top-[58px]
                                                    ...
                                                    <div class="drop_down_fillter_1_action_sec pt-2 pb-3 mt-2 hidden">
                                                        <div class="flex justify-end flex-end">
                                                            <div class="px-2">
                                                                <a href="javascript:void(0);"
                                                                    class="inline-block cursor-pointer capitalize drop_down_fillter_1_done_btn px-5
                                                            ...
                                                            <div class="px-2">
                                                                <a href="javascript:void(0);"
                                                                    class="inline-block drop_down_fillter_1_cancel_btn capitalize px-5
                                     ...
                                     <div class="basis-[33%]  px-2 pl-0">
                                        <div class="w-auto">
                                            <div
                                                class="dropdown_sec_drop dropdown__drop_fillter_btn2 relative cursor-pointer py-2 pl-[18px] rounded pr-11 bg-[#F4F4F4] date_range_block">
                                                <span class="absolute hidden top-[14px] right-[13px] cross_icon"><img
                                                        src="{{asset('images/cross.svg')}}" alt="cross_icon"
                                                        class="w-[14px]"></span>
                                                <span
                                                ...
                                                <div
                                                    class="drop_down_fillter_2 absolute left-0 top-[58px] w-full border border-[#E0DCDC]
                                                fltr_dropdown_shadow bg-[#FFFFFF]  rounded text-left max-h-[62vh] overflow-y-auto  overflow-x-hidden  hidden scroller">
                                                    <ul
                                                        class="overflow-y-scroll carType_list_items overflow-x-hidden scroller py-[3px]">
                                                        @foreach ($uniqueCarTypes as $uniqueCarType)
                                                        <li class="text-[14px] font-normal uniqueCarType">
                                                            <div
                                                                class="chckbox_out_x w-full border-b border-[#E7E7E7] p-2 flex flex-wrap ">
                                                                <label class="chckBoxes_container">
                                                                    <p
                                                                        class="text-[12px] mb-0  font-normal ml-[10px] capitalize break-all">
                                                    ...
                                                    <div class="drop_down_fillter_2_action_sec pt-2 pb-3 hidden">
                                                        <div class="flex justify-start flex-start">
                                                            <div class="px-2 2xl:px-[3px]">
                                                                <a href="javascript:void(0);"
                                                                    class="inline-block cursor-pointer capitalize drop_down_fillter_2_done_btn px-3
                                                                    py-1 text-sm font-normal leading-4 text-black border
                                                                    rounded rounded border-siteYellow bg-siteYellow transition-all duration-300 ease-in-out hover:bg-siteYellow400">done</a>
                                                            </div>
                                                            <div class="px-2">
                                                                <a href="javascript:void(0);"
                                                                    class="inline-block drop_down_fillter_2_cancel_btn capitalize px-3
                                                                    py-1 text-sm font-normal leading-4 text-black rounded rounded border-transparent  transition-all duration-300 ease-in-out hover:bg-siteYellow400 hover:border-siteYellow">
                                                                    cancel
                                                                </a>
                                                            </div>
                                    ...
                                    <div class="basis-[30%] px-2">
                                     ...
                                     <div class="basis-[30%] px-2">
                                        <div class="w-auto">
                                            <div
                                                class="dropdown_sec_drop dropdown__drop_fillter_btn4 relative cursor-pointer py-2 pl-[18px] rounded pr-11 bg-[#F4F4F4] date_range_block">
                                                <span class="absolute hidden top-[14px] right-[13px] cross_icon"><img
                                                        src="{{asset('images/cross.svg')}}" alt="cross_icon"
                                                        class="w-[14px]"></span>
                                                <span
                                                    class="text-sm font-normal leading-4 text-black fltr_count desk_vendor_count"></span><a
                                                    class="text-sm font-normal leading-4 text-black capitalize">
                                                    partners
                                                </a>
                                                <div
                                                    class="drop_down_fillter_4 absolute left-0 top-[58px] w-full border border-[#E0DCDC] fltr_dropdown_shadow bg-[#FFFFFF]  rounded text-left hidden">

                                                    <div class="search_list_filter bg-[#F5F5F5] p-[12px]">
                                                        <div
                                                            class="search_list_item_p partner_search bg-[#ffff] w-full rounded-[30px] py-[3px] px-[7px] flex items-center">
                                                            <img src="{{asset('images/search_icon.svg')}}"
                                                                class="w-[17px]">
                                                            <input type="text" name="search"
                                                                class="py-0 px-[8px] w-full filter_search_inp2 search_list_src outline-none text-[12px] s_search_inp_categ"
                                                                placeholder="Search">
                                                        </div>
                                                        <div class="hidden flex items-center justify-center capitalize pt-4 text-sm text-[#686868] "
                                                            id="vendor_search_no_data_found"> no data found !!</div>

                                                    </div>
                                                    <ul
                                                        class=" max-h-[62vh] overflow-y-auto scroller partner_ul_elememt">
                                                        @foreach ($allPartners as $value)
                                                        <li class="text-[14px] font-normal">
                                                            <div
                                                                class="chckbox_out_x w-full border-b border-[#E7E7E7] p-2 flex flex-wrap ">
                                                                <label class="chckBoxes_container">
                                                                    <p
                                                                        class="text-[12px] mb-0  font-normal ml-[10px] capitalize break-word">
                                                                        @if(Helper::getUserMeta($value->id,
                                                                        'company_name'))
                                                                        {{Helper::getUserMeta($value->id,
                                                                        'company_name')}}
                                                                        @endif
                                                                    </p>
                                                                    <input type="checkbox" name="partner_id[]"
                                                                        value="{{$value->id}}"
                                                                        class="choice_checkBox vendor_checkboxes dsktp_status_checkboxes">
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                            </div>
                                                        </li>
                                                    ...
                                                    <div class="drop_down_fillter_4_action_sec pt-2 pb-3 hidden">
                                                        <div class="flex justify-start flex-start">
                                                            <div class="px-2 2xl:px-[3px]">
                                                                <a href="javascript:void(0);"
                                                                    class="inline-block cursor-pointer capitalize drop_down_fillter_4_done_btn px-3
                                                                    py-1 text-sm font-normal leading-4 text-black border
                                                                    rounded rounded border-siteYellow bg-siteYellow transition-all duration-300 ease-in-out hover:bg-siteYellow400">done</a>
                                                            </div>
                                                            <div class="px-2">
                                                                <a href="javascript:void(0);"
                                                                    class="inline-block drop_down_fillter_4_cancel_btn capitalize px-3
                                                                    py-1 text-sm font-normal leading-4 text-black rounded rounded border-transparent  transition-all duration-300 ease-in-out hover:bg-siteYellow400 hover:border-siteYellow">
                                                                    cancel
                                                                </a>
                                                            </div>
                                ...
                                <div
                                    class=" flex justify-end basis-1/4 3xl:basis-full 3xl:grow-0 3xl:shrink-0 3xl:mb-[8px] 3xl:justify-center">

                                    <div class="flex justify-end -mx-2 flex-end">
                                        <div class="px-2">

                                            <input type="submit"
                                            id="applyDesktopFilterBtn"
                                                class="inline-block cursor-pointer capitalize px-6
                                        py-2.5 text-sm font-normal leading-4 text-black border
                                        rounded rounded border-siteYellow bg-siteYellow transition-all duration-300 ease-in-out hover:bg-siteYellow400"
                                                value="SEARCH">

                                        </div>
                                        <div class="px-2">
                                            <a href="javascript:void(0);"
                                                class="inline-block desktop_clear_btn capitalize px-6
                        ...
                        <div class="flex filter_block_out md:pl-[15px] md:pr-[15px] bg-[#F6F6F6]">
                            <div class="filter_date_l mr-7">
                                <div class=" border-b border-[#F4B20F]">
                                    <a href="javascript:void(0);"
                                        class="date_text_st mobile_filter capitalize py-[5px] ">
                                        <span class="inline-block calender_image_container mr-[6px]">
                                            <img src="{{asset('/images/calender_icon.svg')}}"
                                                alt="calender icon">
                                        </span>
                                ...
                                <div class="text-left ">
                                    <a href="javascript:void(0);" class="date_text_st capitalize mobile_filter py-[5px]">
                                        ...
                                        <span class="mob_filter_count_sec ml-[10px]">
                                            <span
                                                class="inline-block w-[20px] text-center h-[20px] sm:w-[19px] sm:h-[19px] bg-[#FFB600] rounded-full sm:text-[15px]">{{$filtersCount}}</span>
                                        </span>
                                        @endif
        ...
        // echo'carsbypartner:',count($carsByPartner);die;

        @endphp
        @if(count($carsByPartner)>0)
        <div class="relative out_car_range_b ">
                ...
                <div class="cars_custom_calender_inner">
                        ...
                        <div class="flex bg-textGray400 dates_sec_bg   mb-[13px] afclr ">
                            <div class="relative car_status_container  bg-textGray400 right_dates_section">
                                ...
                                <div class="flex justify-between bg-textGray400 dates_main_sec">
                                    <a href="javascript:void(0);" id="left_btn" class="action_btn lr_btn_fix"
                                        data-action-btn="decrease">
                                    ...
                                    <ul class="custom_calender_dates_container">
                                        ...
                                        <li class="inline-block px-[13px] py-1 custom_calender_dates">
                                            ...
                                            <p
                                                class="lg:text-sm font-normal lg:font-medium text-[17px] leading-4 lg:leading-[14px]">
                                                {{$date['day']}}</p>
                                            <p class="text-xs text-black capitalize">{{$date['day_name']}}</p>
                                        </li>
                                        @endforeach
                                    </ul>
                                    <a href="javascript:void(0);" id="right_btn" class="action_btn lr_btn_fix"
                                        data-action-btn="increase">
                                        <img src="{{asset('images/angle-down-n.svg')}}" alt="">
                                    </a>
                                </div>
                                <!-- dates_section ends -->
                    ...
                    <div class="outer_main scrollingContent">
                        ...
                        <div class="main_loop">
                            ...
                            @php
                            $partnerName = Helper::getUserMeta($car->user_id, 'company_name') ?
                            Helper::getUserMeta($car->user_id, 'company_name') : 'Not available';
                                    ...
                                    <div class="car_status_row relative">
                                        <div class="sticky w-max left-[28px] sm:left-[14px]">
                                            <div class="flex justify-start md:mb-[10px]">
                                                <div
                                                    class="car_status_row_sec  md:w-[85px] md:p-[5px] md:bg-[#fff] md:rounded-[17px] left_section car_showcase_main_card md:bg-#fff">
                                                    <div
                                                        class="h-[67px] md:h-[45px] flex justify-center items-center py-[10px] overflow-hidden md:py-[5px] sm:py-1">
                                                        <img src="{{$modifiedImgUrl}}" alt="car image"
                                                            class="object-contain h-full">
                                                    </div>
                                                </div>
                                                <div
                                                    class="car_status_row_sec pl-[15px] right_section md:flex md:flex-row  flex flex-col md:items-start">

                                                    <div
                                                        class="car_details_content md:flex-col md:items-start flex justify-start items-center">
                                                        <div class="car_name_sec">
                                                            <a href="{{route('agent.car.view',$car->id)}}"
                                                                class="links_item_cta text-base md:text-center font-medium capitalize showcar_title_b hover:underline transition-all duration-300 ease-out  text-purple md:font-bold md:text-sm sm:text-xs">
                                                        ...
                                                        <div class="md:block hidden cursor-default">
                                                            <p
                                                                class="py-1 showcase_ct_b text-[14px] font-normal text-textGray500  md:text-sm uppercase sm:text-xs">
                                                                {{$car->registration_number}}
                                                            </p>
                                                        </div>
                                                        <div
                                                            class="car_ragisteration_sec md:hidden pl-2 cursor-default">
                                                            <p
                                                                class="py-1 showcase_ct_b text-[14px] font-normal text-textGray500  md:text-sm uppercase">
                                                                {{$car->registration_number}}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        class="flex items-center mb-[25px] md:mb-[10px] lg:mb-[15px] md:ml-[8px] ">
                                                        <div class="mr-[8px] h-[36px] md:h-[25px] overflow-hidden">
                                                            <img class="object-contain  h-full" src="{{$modifiedUrl}}">
                                                        </div>
                                                        <h2
                                                            class="md:hidden text-base font-medium leading-normal text-black">
                                                            {{$partnerName}}</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <ul class="list selectable" data-car-id="{{$car->id}}"
                                            data-user-id="{{$car->user_id}}">
                                            @foreach ($dates as $date)
                                              <li class="inline-block adj_margin clickable relative"
                                                ...
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-booked-id="{{array_key_exists($date['full_date'], $bookedArr) ? $bookedArr[$date['full_date']][$car->id]['booking']['bookingId'] : '' }}" data-src="#booking_Details_showcase_popup"
                                                    data-overlap-booking-owner-id="{{array_key_exists($date['full_date'], $bookedArr) ?
                                                    $bookedArr[$date['full_date']][$car->id]['additional']['booking_owner_id'] : '' }}"
                                                ...
                                                $bookedArr[$date['full_date']][$car->id]['booking']['id'] : '' }}"
                                                   ...
                                                   data-booked-booking-owner-id="{{array_key_exists($date['full_date'], $bookedArr) ?
                                                    $bookedArr[$date['full_date']][$car->id]['booking']['booking_owner_id'] : '' }}"
                                                   @elseif($isLocked)
                                                    ...
                                                    class="custom_pick_drop_popup booking_details_popup inline-flex
                                                    flex-col items-center justify-center links
                                                    @if($isBooked) booked
                                                    adj_status_width
                                                    @elseif($isLocked) locked
                                                    adj_status_width
                                                    @else activeDate @endif">
                                                    <div class="@if($hasAdditionalBookings) overlap_booking @endif @if($overlapLockedOrNot) overlap_locked @endif">
                                                        <div class="relative range_active spaces_around_status "
                                                            title="{{$formattedFullDate}}">
                                                            <div
                                                                class="mx-auto leading-[0] car_status_container_inner flex items-center cell_dates_day
                                                            @if($isBooked)
                                                            @elseif($isLocked)
                                                            @else
            ...
            <!-- -top-[100px] py-[30px] -->
            <div class="relative text-center py-[50px] flex justify-center lg:py-[25px] loadMore_main_sec lg:my-7 md:mt-0 " id="loadMore_main_sec">
                ...
                text-black transition-all duration-[0.5s] ease-in border-b-2 border-siteYellow " id="loadMore">Load
                    More</a>
                <!-- hover:border-siteYellow -->
            </div>

        </div>
        @else
        <div class="empty_data_container md:px-[15px] empty_cars  w-full ">
            <div class="empty_data_msgContainer w-full adj_empty_car_sec flex bg-white justify-center items-center ">
            ...
            <div class="relative">
                ...
                <div class="bg-[#FFFFFF]">
                    <div class="w-full overflow-y-auto filter_height_sec">
                        <form action="{{route('agent.booking.calendar')}}" id="mob_filters_form" method="GET"
                            ...
                            <div class="flex flex-wrap filter_main">
                                <div class="filter_content_sec bg-textGray400 xsm:w-[26%]  w-1/3 min-h-[751px]">
                                    <div class="filter_tab_sec afclr">
                                        ...
                                        <ul>
                                        @php /*<li class="active">
                                                <a href="#tab1" class=" pl-[10px] w-full flex items-center justify-between text-sm py-[18px] mobDate_tab
                                                        capitalize hover:bg-[#fff] hover:shadow-sm">Date
                                            ...
                                            <li class="active">
                                                <a href="#tab2"
                                                    class="pl-[10px] w-full segment_tab flex items-center
                                                        justify-between py-[18px]  capitalize text-sm hover:bg-[#fff] hover:shadow-sm">segmants
                                                    <span class=" inline-flex w-[20px] h-[20px]">
                                                        <svg class="w-full" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                            viewBox="-10 0 202 512">
                                           ...
                                           <li class="">
                                                <a href="#tab3"
                                                    class="pl-[10px] cars_tab text-sm w-full flex items-center justify-between py-[18px] hover:bg-[#fff] capitalize hover:shadow-sm">transmissions
                                                    <span class=" inline-flex w-[20px] h-[20px]">
                                                        <svg class="w-full" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                            viewBox="-10 0 202 512">
                                           ...
                                           <li class="">
                                                <a href="#tab4"
                                                    class="pl-[10px] partner_tab text-sm w-full flex items-center justify-between py-[18px] hover:bg-[#fff] capitalize hover:shadow-sm">Partner
                                                    <span class=" inline-flex w-[20px] h-[20px]">
                                                        <svg class="w-full" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                            viewBox="-10 0 202 512">
                                ...
                                <div class="filter_table_sec  bg-[#fff] xsm:w-[73%] w-2/3 filter_client_sec afclr">
                                    <div class="filter_table_inner_sec afclr">
                                                        ...
                                                        <li class="font-normal mb-[12px] md:mb-0 ml-[10px] ">
                                                            <div class="flex flex-wrap w-[130px]  break-words">
                                                                <label
                                                                    ...
                                                                    <p
                                                                        class="text-xs mb-0 font-normal checkbox_title  capitalize py-[10px] ml-[17px] mr-[20px] ">
                                                                        @if(strcmp($uniqueCarType,'compact_suv')==0)
                                                                        Compact Suv
                                                                        @elseif(strcmp($uniqueCarType,'luxury')==0)
                                                                        Luxury
                                        ...
                                        <div class="hidden mobile_filter_box afclr " id="tab3" style="display:none;">
                                            <div class="py-[10px] px-[15px]">
                                                <div class="flex mobile_filter_box_tittle ">
                                                    <div class="flex w-1/2 mobile_filter_left_sec ">
                                                        <div>
                                                            <a href="javascript:void(0);" class="cursor-auto text-sm font-normal text-black capitalize"> select
                                                                transmission</a>
                                                        </div>
                                                    </div>
                                                    <div
                                        ...
                                        <div class="hidden mobile_filter_box afclr " id="tab4" style="display:none;">
                                            <div class="py-[10px] px-[15px]">
                                                <div class="flex mobile_filter_box_tittle ">
                                                    <div class="flex w-1/2 mobile_filter_left_sec ">
                                                        <div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <a href="javascript:void(0);"
                                                                class="p-2 text-sm font-normal vendor_choices_clear  capitalize text-[#F4B20F]">
                                                                reset
                                                            </a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <li class="text-xs font-normal">
                                                            <div class="flex flex-wrap w-full ">
                                                                <label class="chckBoxes_container ">
                                                                    ...
                                                                    <input type="checkbox" name="partner_id[]"
                                                                        value="{{$value->id}}"
                                                                        class="choice_checkBox mob_partner_checkboxes
                                                                            clear_checkbox  mob_status_checkboxes">
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                            </div>
                                                        </li>
                        ...
                        <div class="flex flex-col w-full bg-[#fff] items-center  afclr filter_apply_sec">
                            <div class="w-full reset_all_section">
                                <div class="w-full text-center bg-transparent reset_all_inner_sec">
                                    <a href="javascript:void(0);"
                                        class="p-2 reset_all_link capitalize text-[#F4B20F] text-sm">reset all</a>
                                </div>
                            </div>
...
<div class="add_popcar">
    <div class=" mob_booking_details py-2 items-center pt-[15px] pb-2   hidden md:flex flex-col justify-center">
        <div class="pickup_bookingDetails pl-[18px]">
            <p class="font-[18px] font-normal text-[#000] pickup_booking_inner_detail sm:text-[15px]">
                <span>Pickup:</span>
                <span class="" id="mob_show_pickup_booking_date"></span> <span>-</span> <span
                    id="mob_show_pickup_booking_time"></span>
            </p>
        </div>
        ...
        <div class="dropoff_bookingDetails">
            <p class="font-[18px] font-normal text-[#000] pickup_booking_inner_detail sm:text-[15px]"><span>Drop:</span>
                <span class="" id="mob_show_dropoff_booking_date"></span> <span>-</span> <span
                    id="mob_show_dropoff_booking_time"></span>
            </p>
        </div>
    </div>
    <div
        class="relative flex items-center justify-center py-[35px] 2xl:py-[30px] lg:py-[25px] sm:py-[20px] sm:pt-[5px]">
        ...
        <div class="details_bookings md:hidden w-1/2 flex flex-col items-center justify-center pr-[20px]">
            <a href="javascript:void(0);" data-fancybox data-src="#open_popup" class="edit_pickupdatesnd_dropoffdates">
                <div class="md:hidden pickup_bookingDetails flex justify-center pl-4">
                    {{-- <a href="javascript:void(0)" class="edit_pickupdatesnd_dropoffdates"> --}}
                        <p class="font-[18px] font-normal text-[#000] pickup_booking_inner_detail"><span>Pickup:</span>
                            <span class="" id="show_pickup_booking_date"></span> <span>-</span> <span
                                id="show_pickup_booking_time"></span>
                        </p>
                        {{--
                    </a> --}}
                </div>
        ...
        <div class="w-1/2 flex md:flex-col justify-start md:w-[90%]">
            <div class="w-full text-left ">
                <a href="javascript:void(0);"
                    class=" md:w-full md:inline-flex md:justify-between text-center inline-block hover:bg-siteYellow400  min-w-[230px] transition-all duration-300 ease-out rounded-[4px] text-black text-base md:text-sm font-normal bg-siteYellow px-[20px] py-2.5 md:px-[15px] md:min-w-0"
                    id="add_booking">ADD TO BOOKING
                    {{-- <img src="public" alt="" class="md:inline-block hidden"> --}}
                    <span class="inline-flex"><img class="md:w-[36px] md:inline-block hidden rotate-180"
                            src="{{asset('images/panel-back-arrow.svg')}}"></span>

                </a>
            </div>
            <div
                class="add_close_p  md:hidden p-[5px] absolute top-[0px] right-[56px] md:right-[15px] bottom-[0px] mx-auto my-0 text-center flex items-center justify-center">
            ...
            <div class="hidden md:flex md:mt-5 md:justify-between -mx-2 flex-end">
                <div class="px-2">
                    ...
                    <a href="javascript:void(0);" data-fancybox data-src="#open_popup"
                        class=" edit_pickupdatesnd_dropoffdates inline-block capitalize capitalize px-6
                    py-2.5 text-sm font-normal leading-4 text-black rounded rounded border border-siteYellow transition-all duration-300 ease-in-out hover:bg-siteYellow400">CHANGE
                        DATE/TIME
                    </a>
                ...
                <div class="px-2">
                    <a href="javascript:void(0);"
                        class=" add_cl_block inline-block capitalize px-6
                    py-2.5 text-sm font-normal leading-4 text-black rounded rounded border border-siteYellow transition-all duration-300 ease-in-out hover:bg-siteYellow400">
                        CANCEL
                    </a>
                </div>
...
<input type="hidden" id="datepicker_start_date" value="{{$start_date}}">
<input type="hidden" id="datepicker_end_date" value="{{$end_date}}">
        ...
        <div class=" rounded-tl-10 rounded-tr-10 rounded-bl-0 rounded-br-0 custom-shadow">
            ...
            <div
                ...
                <div class="showcase_popup_inner_content">
                        <div class="customer_sec flex w-full customer_name_left_sec">
                ...
                <div class="booking_Details_showcase_popup_links pt-6">
                    ...
                    <div class="flex justify-start -mx-2 flex-end align-center popup_links_inner">
                        ...
                        <div class="px-2 popup_link">
                            <a id="view_booking_cta" href="javascript:void(0);"
                        ...
                        <div class="px-2 popup_link hidden">
                            <a id="new_booking_cta" data-src="#open_popup"
                                class=" inline-block capitalize px-6
                                                        py-2.5 text-sm font-normal leading-4 text-black rounded rounded border border-siteYellow transition-all duration-300 ease-in-out hover:bg-siteYellow400"
...
<script>
    ...
    $('#applyMobileFilterBtn').on('click',function(e){
        e.preventDefault();
         ...
         setTimeout(function() {
             document.getElementById('mob_filters_form').submit();
         }, 2000);
    ...
    //    var navigation_bar_height=$('.navigation').height();
    //    var filter_section_height= $('.dashboard_ct_section').height();
    //    var calculated_height=  window_height - navigation_bar_height-filter_section_height;
    //     console.clear();
    //     console.log('navigation_bar',navigation_bar_height ,'filter_section_height',filter_section_height,'calculated_height:',calculated_height);
    //    $(".empty_data_container").css("height",""+calculated_height+"px");
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '.overlapped_right_part', function (e) {
            ...
            let customer_name = $(this).closest('.links').data('overlap-customer-name');
            let customer_number = $(this).closest('.links').data('overlap-customer-number');
            let pickup_time = $(this).closest('.links').data('overlap-pickuptime');
            let dropoff_time = $(this).closest('.links').data('overlap-dropofftime');
            let pickup_date = $(this).closest('.links').data('overlap-pickupdate');
            let formattedPickupDate = convertdates(pickup_date);
            let dropoff_date = $(this).closest('.links').data('overlap-dropoffdate');
            let formattedDropoffDate = convertdates(dropoff_date);
            let pickup_location = $(this).closest('.links').data('overlap-pickup-location');
            let dropoff_location = $(this).closest('.links').data('overlap-dropoff-location');
            let customer_country_code = $(this).closest('.links').data('overlap-customer-country-code');
            let id = $(this).closest('.links').data('overlap-booked-id');

            let booking_owner_id= $(this).closest('.links').data('overlap-booking-owner-id');

            let viewRoute = `{{ route('agent.booking.view', '__ID__') }}`.replace('__ID__', id);
            $('.customer_name_right_sec').html(getFirstName(customer_name));
            $('.customer_mobile_sec').html(customer_country_code + '&nbsp;' + maskPhoneNumber(customer_number));
            ...
            // console.warn('under the overlapped_right_part:',booking_owner_id);
            ...
            if(booking_owner_id){
            $('#view_booking_cta').closest('.popup_link').show();
            }else{
            $('#view_booking_cta').closest('.popup_link').hide();
        ...
        $('body').on('click', '.booked', function (e) {
            ...
            let isPinkishBgClicked = $(this).find('.pinkishBg').length > 0;
                ...
                if($(this).find('.overlapped_span').hasClass('overlapped_right_part')){
                    ...
                    // this will check if the click is left side or right side of anchor and proceed accordingly
                    if (position > 0.5) {
                    ...
                    var id = $(this).data('booking-id');
                    var booking_owner_id= $(this).data('booked-booking-owner-id');
                    // console.warn('under the overlapped_right_part:',booking_owner_id,'id:',id);
           ...
           $('.customer_mobile_sec').html(customer_country_code + '&nbsp;' + maskPhoneNumber(customer_number));
            ...
            $.fancybox.open({
                ...
                beforeShow: function(instance,current)
                {
                    ...
                    // let li= current.opts.$orig.closest('li').data('date-full_date');
                    // console.warn('li:',li);
    ...
    //// let isPinkishBgClicked = $(this).find('.pinkishBg').length > 0;
    //// let isOverlapBookingClicked = $(this).find('.overlap_booking ').length > 0;
    ...
    $('.drop_down_fillter_4_done_btn, .drop_down_fillter_4_cancel_btn').on('click', function () {
        $(".drop_down_fillter_4").slideUp();
    ...
    function calendarScroll() {
        ...
        let startX;
        let scrollLeft;
        // var slider = $(".dates_sec_sticky, .outer_main");
    ...
    // scrolling respectively functionality
    // $('.dates_sec_sticky').on('scroll', function() {
    //     $('.outer_main').scrollLeft($(this).scrollLeft());
    // });
    // $('.outer_main').on('scroll', function() {
    ...
    $('.vendor_checkboxes').on('change', function (e) {
        console.log('vendor_checkboxes count',$('.vendor_checkboxes:checked').length);
        if ($('.vendor_checkboxes:checked').length > 0) {
            $(this).closest('.dropdown_sec_drop').addClass('bg-[#F9F1CB]');
            $(this).closest('.dropdown_sec_drop').removeClass('date_range_block');
            $(this).closest('.dropdown_sec_drop').find('.cross_icon').show();
            let anchor = $(this).closest('.dropdown_sec_drop').find('a');
            let checkedCount = $('.vendor_checkboxes:checked').length;
            $('.desk_vendor_count').html('(' + checkedCount + ')');
            $('.drop_down_fillter_4_action_sec').show();
            ...
            $('.drop_down_fillter_4_action_sec').hide();
    ...
    $('.mob_partner_checkboxes').on('change', function (e) {
        if ($('.mob_partner_checkboxes:checked').length > 0) {
            $('.partner_tab').addClass('bg-[#F9F1CB]');
        } else {
    ...
    $(".filter_search_inp2").on("keyup", function () {
        let value = $(this).val().toLowerCase();
        let items = $(".drop_down_fillter_4 li");
        let filteredItems = items.filter(function () {
            return $(this).text().toLowerCase().indexOf(value) > -1;
        });
        items.hide();
        filteredItems.show();
        if (filteredItems.length === 0) {
            $("#vendor_search_no_data_found").css('display', 'flex');
        } else {
    ...
    $('.vendor_choices_clear').on('click', function (e) {
        $('.vendor_checkboxes').each(function () {
            $(this).prop('checked', false);
            $('.partner_tab').removeClass('bg-[#F9F1CB]');
        });
    });
    ...
    function clearCalendar() {
        const calanderUrl = "{{route('agent.booking.calendar')}}";
        hideLoader();
    ...
    //                 if (date.formattedDate[0] !== undefined) {
    //                     $('.mobile_fltr_start_date').val($objDate);
    //                     $('.mobDate_tab').addClass('bg-[#F9F1CB]');

    //                 } else {
    //                     $('.mobile_fltr_start_date').val('');
    //                     $('.mobDate_tab').removeClass('bg-[#F9F1CB]');
    ...
    $(".dropdown__drop_fillter_btn4 ").click(function (e) {
        e.stopPropagation();
        $(".drop_down_fillter_4").slideToggle();
        $(".drop_down_fillter_1").slideUp();
        $(".drop_down_fillter_2").slideUp();
        $(".drop_down_fillter_3").slideUp();
    });
    ...
    function loadMoreDates(action_btn) {
        ...
        $.ajax({
            url: "{{ route('agent.booking.filter')}}",
            type: 'POST',
            data: {
                '_token': '{{ csrf_token() }}',
                'full_date': full_date,
    ...
    $('#add_booking').on('click', function () {
        ...
        $(".overlay_sections").css("display", "block");
        $.ajax({
            url: "{{ route('agent.booking.calendar.post') }}",
            type: 'POST',
            data: {
                '_token': '{{ csrf_token() }}',
                'carDetails': details,
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var url = "{{ route('agent.edit.customer.details', ':id') }}";
                            url = url.replace(':id', bookingId);
                            window.location.href = url;
                        }
                        else if (!result.isConfirmed){
                            window.location.href = "{{route('agent.booking.list')}}";
                        }
                    });
                }
            });
    ...
    function loadMore()
    {
        ...
        $.ajax({
            url: "{{ route('agent.booking.calendar.load.more') }}",
            method: "GET",
            data: {
                'start': start,
                'userIds': userIds,
    ...
    function getAllBookedAndLockedDates(carId) {
        let car_id = carId;
        $.ajax({
            url: "{{ route('agent.getAllBookedAndLockedDates') }}",
            method: "post",
            data: {
                'carId': car_id,
                _token: '{{ csrf_token() }}',
    ...
    $('body').on('click', '.links, .edit_pickupdatesnd_dropoffdates, #new_booking_cta', function (e) {
        ...
        // console.log('under new_booking_cta',isNewBookingClicked);
        if(isPinkishBgClicked){
        return false;
        }
        ...
        if (isDatesEditClicked) {
           ...
           select_pickup();
            ...
            // console.log('isPinkishBgClicked:', isPinkishBgClicked);
            ...
            // add preceding 0 when hours is single digit
            ...
            // let isPinkishBgClicked= $(this).find('.car_status_container_inner').hasClass('pinkishBg');
    ...
    $(".datepicker_inner_b").click(function () {
        ...
        // console.warn('under the datepicker_inner_b:','temp_time:',temp_time);
    ...
    $(".datepicker_inner_b2").click(function () {
        ...
        // console.warn('datepicker_inner_b2 click:',temp_time);
                        ...
                        if (liDate === bookingEndDate) {
                            ...
                            if (!overlapDateActive) {
                                ...
                                if (diffBetweenDates == 1) {
                                    ...
                                    if (firstIndex !== -1 && lastIndex !== -1) {
                                        ...
                                        if (!rangeActiveElement.children('.days_showcase').length > 0) {
                                            ...
                                            // console.warn(' overlap date didnt active ', bookingStartDate,bookingEndDate,diffBetweenDates,'index:',rangeActiveElement)
                                    ...
                                    if (firstIndex !== -1 && lastIndex !== -1) {
                                        ...
                                        if (bookingStartDate < calender_start_date) {
                                            ...
                                            if (bookingStartDate == bookingStartDate && liElements.eq(firstIndex).data('date-full_date') != bookingStartDate) {
                                                ...
                                                if(bookingDiff==0 || bookingDiff==1){
                                                    ...
                                                    if (!anchor.find('.range_active').children('.days_showcase').length > 0) {
                                                    // console.warn('current anchor:',anchor);
                                                    anchor.find('.range_active').prepend('<div class=" absolute w-max days_showcase  md:text-[14px] z-[2] text-white -right-2 sm:-right-[6px]  top-[10px] md:top-3  sm:text-xs">' + diffBetweenDates + ' Days</div>');
                                                }
                                ...
                                if (overlapDiffBookedDates >= 1) {
                                    ...
                                    rangeActiveElement.closest('.clickable').append('<div class=" bookingDetails  bookingDetails12 absolute z-2 -left-[12px] top-[47px] text-sm text-right">' +
                                ...
                                if (secondDate != firstDate) {
                                    ...
                                    if (diffBetweenDates == 1) {
                                        ...
                                        if (firstIndex !== -1 && lastIndex !== -1) {
                                            ...
                                            if (!rangeActiveElement.children('.days_showcase').length > 0) {
                                            // console.warn('underoverlap  diffBetweenDates','bookingStartDate', bookingStartDate, 'bookingEndDate', bookingEndDate, 'overlapStartDate:', overlapPickupDate, 'overdropoffdate:', overlapDropoffDate, 'overlapDiffBetweenDates:', overlapDiffBetweenDates, 'overlapDiffBookedDates:', overlapDiffBookedDates,'rangeActiveElement:',rangeActiveElement,'middleElement:',middleElement);
                                            ...
                                            if(liElements.eq(overlapMiddleIndex+1).find('.overlapped_span').length>0){
                                                ...
                                                if (firstIndex !== -1 && lastIndex !== -1) {
                                                    ...
                                                    if (!overlapAnchor.find('.range_active').children('.days_showcase').length > 0) {
                                                        // console.warn('underoverlap overlapBetweenDays','bookingStartDate', bookingStartDate, 'bookingEndDate', bookingEndDate, 'overlapStartDate:', overlapPickupDate, 'overdropoffdate:', overlapDropoffDate, 'overlapDiffBetweenDates:', overlapDiffBetweenDates, 'overlapDiffBookedDates:', overlapDiffBookedDates,'rangeActiveElement:',rangeActiveElement,'middleElement:',overlapAnchor);
                                    ...
                                    if (firstIndex !== -1 && lastIndex !== -1) {
                                        ...
                                        if (bookingStartDate < calender_start_date) {
                                            ...
                                            if (bookingDiff > 0) {
                                                ...
                                                // console.warn('bookingStartDate', bookingStartDate, 'bookingEndDate', bookingEndDate, 'overlapStartDate:', overlapPickupDate, 'overdropoffdate:', overlapDropoffDate, 'overlapDiffBetweenDates:', overlapDiffBetweenDates, 'overlapDiffBookedDates:', overlapDiffBookedDates,'anchor:',anchor);
                                        ...
                                        if (bookingStartDate < calender_start_date) {
                                            ...
                                            if (bookingDiff > 0) {
                                                ...
                                                if (!anchor.find('.range_active').children('.days_showcase').length > 0) {
                                                    ...
                                                    // console.log('bookingStartDate:',bookingStartDate,'bookingEndDate',bookingEndDate,'under different 4 days ','anchors:',anchor);

                                                    const anchor = middleElement.find('.links');
                                                    anchor.find('.range_active').prepend('<div class="days_showcase absolute w-[90px]  md:text-[14px] z-[2] text-white right-0 left-[0px] md:top-3 top-[10px] sm:text-xs">' + diffBetweenDates + ' Days</div>');
                                                }
                                            ...
                                            // console.warn('bookingStartDate:',bookingStartDate,'bookingEndDate:',bookingEndDate, 'calender_start_date:',calender_start_date,'calender_end_date',calender_end_date,'startDateIndex:',startDateIndex,'endDateIndex:', rangeActiveElement.closest('.clickable').index(),'middleElement:',middleElement);
                                            ...
                                            if (!anchor.find('.range_active').children('.days_showcase').length > 0) {
                                                ...
                                                // console.log('bookingStartDate:',bookingStartDate,'bookingEndDate',bookingEndDate,'under different 4 days ','anchor:',anchor);

                                                // const anchor = middleElement.find('.links');
                                                anchor.find('.range_active').prepend('<div class=" days_showcase helloOverlap absolute w-max   md:text-[14px] z-[2] text-white right-0 left-[0px] md:top-3 top-[10px] sm:text-xs">' + diffBetweenDates + ' Days</div>');
                                ...
                                if (overlapBetweenDays >= 4) {
                                    ...
                                    if (firstIndex !== -1 && lastIndex !== -1) {
                                        ...
                                        if(calender_end_date> overlapDropoffDate){
                                            ...
                                            // console.warn('bookingStartDate:',bookingStartDate,'bookingEndDate:',bookingEndDate, 'calender_start_date:',calender_start_date,'calender_end_date',calender_end_date,'endDateIndex:','overlapAnchor:',overlapAnchor,'overlapfirsttdateIndex:',overlapBookedFirstIndex,'overlaplastDateindex:',overlapBookedLastIndex,'overlappickupdate:',overlapPickupDate,'overlapdropoffdate:',overlapDropoffDate);
            ...
            currentUl.find('li').each(function (index) {
                ...
                if (liDate >= startDate && liDate <= endDate) {
                    ...
                    if (startDate == endDate || lockedStartDate ==lockedEndDate ) {
                        ...
                        // console.warn('both dates equals','lidate:',liDate,'lockedEndDate:',lockedEndDate,'check:',lockedPreviousDate.children('.links').find('.overlap_locked').length>0,'previousDate:',lockedPreviousDate,'match start and end:',startDate== endDate,'match lockedStartDate ==lockedEndDate',lockedStartDate ==lockedEndDate,'rangeActiveElement:',rangeActiveElement.children('.links').find('.overlap_locked').length>0,'all_match:',(startDate== endDate && lockedStartDate ==lockedEndDate && rangeActiveElement.children('.links').find('.overlap_locked').length>0));

                        // if(startDate== endDate && lockedStartDate ==lockedEndDate && rangeActiveElement.children('.links').find('.overlap_locked').length>0 ){

                        //     console.log('under if dates is equal and have overlapped locked');
                        ...
                        // }else{
                            ...
                            else if (lockedStartDate = lockedEndDate)
                            {
                               ...
                               // rangeActiveElement.closest('.clickable').append('<div class="absolute z-2 right-[5px] top-[47px] bookingDetails"><p class="text-[#808080] text-right md:text-sm sm:text-xs"> <span class="hidden">End</span>'+'&nbsp;'+rangeActiveElement.closest('.links').data('pickuptime')+'&nbsp'+' </p> <p class="bookedDropoffTime text-right text-[#808080] md:text-sm md:break-normal whitespace-normal leading-none md:w-[full] sm:text-xs">'+'&nbsp;'+rangeActiveElement.closest('.links').data('dropofftime')+' </p></div>');
                            }
                        // }
    ...
    function handleLockedDateRangeConditions() {
        ...
        // console.log('allLockedDates:',allLockedDates);
        let flag = false;
    ...
    function checkLockedAndBooked(car_id, startDate, endDate,pickTime,dropTime, action_type, callback) {
        let flagBase;
        $.ajax({
            url: "{{ route('agent.checkLockedAndBooked') }}",
            method: "post",
            data: {
                'startDate': startDate,
                'endDate': endDate,
    ...
    function afterDropOff() {
        ...
        checkLockedAndBooked(car_id, startDate, endDate,pickTime,dropTime, action_type, function (result) {
            ...
            if (result == true) {
                Swal.fire({
                    title: 'Please select a valid date, Either dates are Locked or Booked !! ',
                    icon: 'warning',
                    showCancelButton: false,
                    confirmButtonText: 'OK',
                    customClass: {
    ...
    $('.pickup_save').on('click', function () {
        ...
        if (pickup_date_val != '') {
            ...
            // console.warn('warn pickup_time:',$('#datepicker_pickup_time').val(),'dropoff_time:',$('#datepicker_dropoff_time').val());
            // $('#datepicker_pickup_time').val($('#datepicker_pickup_time').val());
    ...
    var partner_id = @json($partner_id);
    var partner_idArray = [];
    if (partner_id.length > 0) {
        partner_id.forEach(element => {
            partner_idArray.push(element);
        });
    }
    $(document).ready(function () {
        $('.drop_down_fillter_2').find('.carType_list_items').children('li').each(function () {
            let carTypeelementValue = $(this).find('.dsktp_car_type_checkboxes').val();
            if (car_typeArray.includes(carTypeelementValue)) {
                // console.log('Match found for value: ' + carTypeelementValue);
        ...
        // console.log('car_nameArray', car_nameArray);
        $('.desktop_filter_search').children('li').each(function () {
            ...
            if (transmissionArray.includes(carNameelementValue)) {
                // console.log('Match found for value: ' + carNameelementValue);
        ...
        $('.partner_ul_elememt').children('li').each(function () {
            var partner_idelmentValue = $(this).find('.dsktp_status_checkboxes').val();
            if (partner_idArray.includes(partner_idelmentValue)) {
                // console.log('Match found for value: ' + partner_idelmentValue);
                $(this).find('.dsktp_status_checkboxes').prop('checked', true);
                $('.dropdown__drop_fillter_btn4').addClass('bg-[#F9F1CB]');
                $('.dropdown__drop_fillter_btn4').removeClass('date_range_block');
                $('.dropdown__drop_fillter_btn4').find('.cross_icon').show();
                let checkedCount = $('.dsktp_status_checkboxes:checked').length;
                $('.desk_vendor_count').html('(' + checkedCount + ')');
            }
        });


        $('.mob_partner_checkboxes').each(function () {
            let partner_idelmentValue = $(this).val();
            if (partner_idArray.includes(partner_idelmentValue)) {
                $(this).prop('checked', true);
                $('.partner_tab').addClass('bg-[#F9F1CB]');
            }
