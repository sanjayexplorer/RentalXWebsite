...
<div>
    ...
    <div class="lg:flex hidden lg:bg-white lg:mb-[0px] lg:px-[17px] lg:py-[15px] mb-[20px] justify-start items-center">
        <a href="{{ route('agent.leads.list') }}" class="links_item_cta inline-block p-2 mr-2 border border-[#C8C0C0] rounded-md
    ...
    <div class="pt-[42px] px-[36px] lg:px-[17px] lg:py-[25px] xl:py-10 bg-[#F6F6F6] !pb-[100px]  min-h-screen lg:flex lg:justify-center">
        ...
        <div class="max-w-[768px] w-full bg-white lg:bg-[#F6F6F6] rounded-[10px] px-12 lg:px-[0px] py-9 lg:py-[0px]">
            <div class="booking_section">
                <form action="{{ route('agent.leads.add.post') }}" method="POST" onsubmit="return checkForm()">
                    @csrf
                    ...
                    <div class="pb-5">
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-full px-3 sm:w-full ">
                                <label class="block pb-2.5 font-normal leading-4 text-left text-black text-sm "
                                    for="pick_up_date_time">Pick up Date & Time<span class="text-[#ff0000]">*</span></label>
                                <input type="datetime-local" tabindex="-1" name="pick_up_date_time" value="{{ old('pick_up_date_time') }}"
                                    onkeyup="checkBlankField(this.id,'Pick up date & time is required','errorPickUpDateTime')"
                                    onchange="checkBlankField(this.id,'Pick up date & time is required','errorPickUpDateTime')"
                                    class="w-full px-5 py-3 font-normal leading-normal text-black bg-white border rounded-md required_field border-black500 focus:outline-none focus:border-siteYellow text-base "
                                    placeholder="Enter Pick up Date & Time" id="pick_up_date_time" data-error-msg="Pick up date & time is required">
