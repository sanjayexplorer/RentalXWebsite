...
<style>
   ...
   /* .tab_section_btns{ position: relative; border-bottom:1px solid #D9D9D9; } */
   .book_tab_contain_b{ position: relative; border-bottom:1px solid #D9D9D9; }
   .booking_section {display: none;}
   .book_navigation_b{ display: none; }
   .book_navigation_b .book_sl_btn{ position: absolute; content: ''; width: 16px; height: 16px; top: 0; bottom: 0px; margin: auto;  background-image: url("{{ asset('images/right-arrow-book.svg') }}"); background-repeat: no-repeat; background-position: center; background-size: contain; }
   .book_next.book_sl_btn{ right: 0px; } .book_prev.book_sl_btn{ transform: rotate(180deg); left: 0px; }
...
<div class="">
    ...
    <div class="lg:flex hidden lg:bg-white lg:mb-[0px] lg:px-[17px] lg:py-[15px] mb-[20px] justify-start items-center">
        <div class="flex justify-start items-center w-full">
            <a href="{{route('agent.leads.list')}}" class="links_item_cta inline-block p-2 mr-2 border border-[#C8C0C0] rounded-md hover:border-[#F3CD0E] active:border-[#000] active:bg-[#F3CD0E]">
                <img class="w-[15px]" src="{{ asset('images/short_arrow.svg') }}">
            </a>
            <span class="inline-block text-xl font-normal leading-normal align-middle text-black800">Lead Details</span>
        </div>
    ...
    <div class="pt-[42px] px-[36px] lg:px-[17px] lg:py-[25px] xl:py-10 bg-[#F6F6F6] !pb-[100px]  min-h-screen lg:flex lg:justify-center relative">
        ...
        <div class="lg:hidden mb-[36px] lg:mb-[20px] flex flex-col">
            <div class="back-button">
                <a href="{{route('agent.leads.list')}}" class="links_item_cta inline-flex py-1 px-2 border border-[#C8C0C0] rounded-md bg-[#fff] hover:border-[#F3CD0E] active:border-[#000] active:bg-[#F3CD0E]">
                    <img  class="w-[15px]" src="{{ asset('images/short_arrow.svg') }}">
        ...
        <div class="basic_info_sec_head mb-[30px]">
           <h4 class="capitalize text-[20px] font-normal pb-[10px]">{{($leads->customer_name)?$leads->customer_name:''}}</h4>
            ...
            {{-- /////// --}}
            <div class="mt-[30px]  ">
                <div class="book_tab_contain_b w-full sm:flex sm:justify-center ">
                    <div class="overflow-hidden relative book_tab_contain sm:max-w-[330px] xsm:max-w-[250px]">

                        <ul class="tab_section_btns flex items-center flex-start  ">
                            <li class="tab_active tab_container"><a class="px-2 pb-4 inline-block tablink sm:px-4" href="booking_section_1">Details</a></li>
                            <li class="tab_container"><a class="px-2 pb-4 inline-block tablink sm:px-4" href="booking_section_2">Activity</a></li>
                            <li class="tab_container"><a class="px-2 pb-4 inline-block tablink sm:px-4" href="booking_section_3">Notes</a></li>
                            <li class="tab_container"><a class="px-2 pb-4 inline-block tablink sm:px-4" href="booking_section_4">Calls</a></li>
                            <li class="tab_container"><a class="px-2 pb-4 inline-block tablink sm:px-4" href="booking_section_5">Emails</a></li>
                            <li class="tab_container"><a class="px-2 pb-4 inline-block tablink sm:px-4" href="booking_section_6">Messages</a></li>
                        </ul>

                    </div>
                        <div class="book_navigation_b">
                            <div class="book_prev book_sl_btn"></div>
                            <div class="book_next book_sl_btn"></div>
                        </div>
                </div>
            </div>
            {{-- ///// --}}
        ...
        {{-- NOTES --}}
        <div class="booking_section  mt-6 mb-6 " id="booking_section_3">
            ...
            <div class="booking_section_b w-full">
                <div class="flex ">
                    ...
                    <div class="left_part w-1/2 flex justify-start">
                        <div class="month_activity_title pb-[15px]">
                            <h4 class="capitalize text-[#A5A5A5] font-normal text-base ">March 2024</h4>
                        </div>
                    </div>

                    <div class="right_part   w-1/2 flex justify-end ">

                        <div class="activities_right_sec w-full text-right flex justify-end items-start hidden sm:block">
                            <div class="activities_timestamp">
                                <p class="font-normal text-[14px] text-[#A3A3A3]">{{$formatted_date}}</p>
                            </div>
                        </div>

                        <div class="activities_right_sec w-full text-right flex justify-end items-start block sm:hidden">
                            <div class="activities_timestamp flex">
                                <span class="flex justify-center"><img class="w-[15px]" src="{{ asset('images/add_icon.svg') }}"></span>
                                <p class="font-normal text-[14px] ml-[5px] ">Add Note</p>
                            </div>
                        </div>
                ...
                <div class="activities__outer">
                    ...
                    <div class="activities_main_container pb-4">
                            <div class="activities_inner_content p-4 bg-[#F6F6F6] flex  justify-center sm:justify-start ">
                                ...
                                <div class="activities_left_sec w-[75%] text-left  sm:w-full">
                                    <div class="activities_title pb-1">
                                        <h4 class="capitalize font-medium text-[14px] text-[#000]">Notes by John Doe</h4>
                                    </div>

                                    <div class="activities_description">
                                        <p class="capitalize font-normal text-[14px] text-[#000]">Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source.</p>
                                    </div>
                                </div>

                                <div class="activities_right_sec w-[25%] text-right flex justify-end items-start sm:hidden ">
                                    <div class="activities_timestamp">
                                        <p class="font-normal text-[14px] text-[#A3A3A3]">Mar 19,2024 at 12:30 pm ISD</p></div>
                                </div>
                ...
                <div class="activities_add_note_sec w-full text-center flex justify-center items-center hidden sm:block">
                    <div class="activities_timestamp flex justify-center">
                        <span class="flex justify-center"><img class="w-[15px]" src="{{ asset('images/add_icon.svg') }}"></span>
                        <p class="font-normal text-[14px] ml-[5px] ">Add Note</p>
                    </div>
                </div>
        ...
        {{-- EMAILS --}}
        <div class="booking_section  mt-6 mb-6 " id="booking_section_5">
            ...
            <div class="booking_section_b w-full">
                ...
                <div class="activities__outer">
                    ...
                    <div class="activities_main_container pb-4">
                        ...
                        <div class="activities_inner_content p-4 bg-[#F6F6F6] flex  justify-center sm:justify-start mb-[10px]">

                                <div class="activities_left_sec w-[75%] text-left  sm:w-full">
                                    <div class="activities_title pb-1">
                                        <h4 class="capitalize font-medium text-[14px] text-[#000]">Engage Welcome mail sent</h4>
                                    </div>
                                </div>
                        ...
                        <div class="activities_inner_content p-4 bg-[#F6F6F6] flex  justify-center sm:justify-start ">
                            ...
                            <div class="activities_left_sec w-[75%] text-left  sm:w-full">
                                <div class="activities_title pb-1">
                                    <h4 class="capitalize font-medium text-[14px] text-[#000]">Ajay Bisht opened email</h4>
                                </div>
                            </div>
...
<script>
    $('.tab_section_btns .tablink').on('click', function(e) {
        e.preventDefault();
        $('.tab_container').removeClass('tab_active');
        $('.booking_section').hide();
        var temp = $(this).attr('href');
        ...
        console.log(temp);
        $('#' + temp).show(); // Corrected concatenation here
        $(this).closest('.tab_container').addClass('tab_active');
    });
    ...
    $(document).ready(function () {
       ...
       var total_width = $('.tab_section_btns')[0].scrollWidth;
       var ara_width  =$('.book_tab_contain_b').innerWidth()
        if(total_width>ara_width){
    $(".book_navigation_b").show();
        }

    });

    $('.book_prev.book_sl_btn').on('click', function(ev) {
        $('.tab_section_btns').animate({ scrollLeft: '-=60' }, 500);
    });

    $('.book_next.book_sl_btn').on('click', function(ev) {
        $('.tab_section_btns').animate({ scrollLeft: '+=60' }, 500);
    });
          ...
          $('.scroller-btn.left').addClass('inactive');
           ...
           $('.scroller-btn.left').removeClass('inactive');
            ...
            $('.book_next').on('click', function(){
                console.log("next");
                $('.book_tab_contain').animate({scrollLeft: '+=200px'}, 300);
