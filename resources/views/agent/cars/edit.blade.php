...
<div>
    ...
    <div class="lg:flex hidden lg:bg-white lg:mb-[0px] lg:px-[17px] lg:py-[15px] mb-[20px] justify-start items-center">
        <a href="{{route('agent.car.list')}}" class="inline-block py-2 mr-2">
            <img class="w-[35px]" src="{{asset('images/panel-back-arrow.svg')}}">
        </a>
    ...
    <div class="pt-[42px] px-[36px] lg:px-[17px] lg:py-[25px] xl:py-10 bg-[#F6F6F6] !pb-[100px]  min-h-screen lg:flex lg:justify-center">
        <div class="lg:hidden mb-[36px] flex justify-start items-center">
            <a href="{{route('agent.car.list')}}" class="inline-block py-2 mr-2">
                <img class="w-[42px]" src="{{asset('images/panel-back-arrow.svg')}}">
            </a>
            <span class="inline-block text-[26px] font-normal leading-normal align-middle text-black800">Edit Car Details</span>
        </div>

        <div class="max-w-[768px] w-full bg-white lg:bg-[#F6F6F6] rounded-[10px] px-12 lg:px-[0px] py-9 lg:py-[0px]">
            <div class="booking_section">
                <form action="{{route('agent.car.edit.post',$cars->id)}}" method="POST" onsubmit="return checkForm()">
                    @csrf
                    <!-- Select Partner -->
                    <div class="pb-5">
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-full px-3 sm:w-full">
                                <label for="partner_id" class="block pb-2.5 font-normal leading-4 text-left text-black text-sm">
                                    Select Company Name<span class="text-[#ff0000]">*</span></label>
                                    <select name="partner_id" id="partner_id"
                                    onchange="handlePartnerChange(); checkBlankField(this.id,'Partner name is required','errorCompanyName');"   class="w-full py-3 pl-5 pr-10 font-normal leading-normal text-black bg-white border rounded-md appearance-none required_field  border-black500 focus:outline-none focus:border-siteYellow drop_location_select text-base sm:text-base"
                                    ...
                                    @foreach ($partners as $partner)
                                        <option value="{{$partner->id}}" @if($partner->id == $cars->user_id) selected @endif>
                                            {{ Helper::getUserMeta($partner->id,'company_name') }}
                                        </option>
                                    @endforeach
                    ...
                    <div class="pb-5">
                        ...
                        <input type="text" name="car_name" value="{{$cars->name}}"
                        ...
                        text-black bg-white border rounded-md border-black500 focus:outline-none focus:border-siteYellow text-base sm:text-base"
                                        ...
                                        <div class="car_box relative border flex flex-col justify-between h-full bg-[#fff] rounded-[12px] ">
                                            ...
                                            <div class=" flex relative">
                                                ...
                                                @if(count($thumbnails)>0)
                                                    <a data-delete-url="{{route('agent.upload.car.images.delete',$thumbnail->imageId)}}"  class="removeProfileBtn flex item-center justify-center p-2 w-1/2 border border-b-none border-r-none" href="javascript:void(0);">
                                ...
                                <div class="uploader_container w-1/3 sm:w-1/2 md:mb-2.5 px-2.5 py-2.5">
                                    <div  class="upload_height bg-white flex items-center justify-center booking_inner_b cursor-pointer border  min-w-[100px] !w-full ">
                                        <label for="car_photos"
                                            class="flex flex-col items-center justify-center w-full text-center cursor-pointer py-[42px]">
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="registration_number_container w-full px-3 sm:w-full ">
                                    ...
                                    <div class="flex relative">
                                        ...
                                        <input type="text" name="registration_number" value="{{$cars->registration_number}}"
                                            ...
                                            placeholder="Enter Registration number" id="car_number" data-error-msg="Registration number is required" disabled >
                    ...
                    <div class="flex flex-wrap -mx-[9px] sm:-mx-[0px] pb-5">
                        ...
                        <div class="w-1/2 px-[9px] sm:px-[0px] sm:w-full">
                            <label for="car_type" class="inline-block pb-2.5 font-normal leading-4 text-left text-black text-sm">Segment<span class="text-[#ff0000]">*</span></label>
                                <select name="car_type" id="car_type" onchange="checkBlankField(this.id,'Segment is required','errorCartype')"
                    ...
                    <div class="flex flex-wrap -mx-[9px] sm:-mx-[0px] pb-5">
                        ...
                        <div class="w-1/2 px-[9px] sm:px-[0px] w-full">
                                ...
                                text-black bg-white border rounded-md border-black500 focus:outline-none
                                focus:border-siteYellow appearance-none border drop_location_select text-base"
                                    data-error-msg="Manufacturing year is required text-base">
                    ...
                    <div class="flex flex-wrap -mx-[9px] sm:-mx-[0px] pb-5">
                        ...
                        <div class="inp_container w-1/2 px-[9px] sm:px-[0px] sm:w-full">
                            <label for="price"
                                class="inline-block pb-2.5 text-sm font-normal leading-4 text-left text-black">
                    ...
                    <div class="flex flex-wrap -mx-[9px] sm:-mx-[0px] pb-5">
                        ...
                        <div class="w-1/2 px-[9px] sm:px-[0px] sm:w-full">
                            ...
                            focus:border-siteYellow appearance-none border drop_location_select text-base"
                                ...
                                <option value="0" disabled class="capitalize text-midgray fontGrotesk">Select Roof Type</option>
                        ...
                        <div class="w-1/2 sm:mt-5 px-[9px] sm:px-[0px] sm:w-full">
                            ...
                            <select name="plate_type" id="plate_type" onchange="checkBlankField(this.id,'Plate type is required','errorRoofType')"
                            class="required_field s_tag_haf w-full pl-5 pr-10 py-3 font-normal leading-normal
                            text-black bg-white border rounded-md border-black500 focus:outline-none
                    ...
                    <div class="mt-5 form_btn_sec afclr">
                        <input type="submit" value="SAVE CAR DETAILS"
                            class="inline-block w-full px-5 py-3 text-opacity-40 font-medium leading-tight transition-all duration-300 border border-siteYellow rounded-[4px] cursor-pointer bg-siteYellow  md:px-[20px] md:py-[14px] sm:py-[12px] transition-all duration-500 ease-0 hover:bg-[#d7b50a]  disabled:opacity-40 disabled:cursor-not-allowed text-sm">
                    </div>
...
<!-- Add this script block before your existing script -->
<script>
    // Declare the cleave variable in the global scope
    var cleave;

    // Declare the updateCleaveFormat function in the global scope
    function updateCleaveFormat() {
        var formatSelect = document.getElementById('formatSelect');
        var selectedFormat = formatSelect.value;
        // Customize blocks based on the selected format
        var blocks;
        var placeholder;
   ...
   $("#car_photos").on('change', function(e) {
    ...
    if (files.length > 0) {
        ...
        for (var i = 0; i < files.length; i++) {
           ...
           $.ajax({
                url: "{{ route('agent.upload.car.images') }}",
                data: form_data,
                type: 'POST',
                contentType: false,
                processData: false,
            ...
            var deleteUrl = '{{ route("agent.upload.car.images.delete", ":deleteUrl") }}';
                        ...
                        <div class=" rounded-[12px] ">
                            <div class="car_box relative border flex flex-col justify-between h-full bg-[#fff] rounded-[12px] ">
                                ...
                                <div class="relative flex">
                                    <a href="javascript:void(0);" class="clicked_area flex justify-center w-1/2 p-2 border  featured_picture_anchor item-center border-l-none border-b-none border-r-none">
                                        <img class="block w-4 h-4" src="{{ asset('images/blank_star_img.svg') }}" alt="icon">
                                    </a>
                                    <a href="javascript:void(0);" data-delete-url="${deleteUrl}" class="flex justify-center w-1/2 p-2 border removeProfileBtn item-center border-r-none border-b-none ">
