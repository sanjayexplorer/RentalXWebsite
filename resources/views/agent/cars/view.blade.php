...
<div class="">
    ...
    <div class="lg:flex hidden lg:bg-white lg:mb-[0px] lg:px-[17px] lg:py-[15px] mb-[20px] justify-start items-center">
        <a href="{{ route('agent.car.list') }}" class="links_item_cta inline-block p-2 mr-2 border border-[#C8C0C0] rounded-md hover:border-[#F3CD0E] active:border-[#000] active:bg-[#F3CD0E]">
    ...
    <div class="pt-[42px] px-[36px] lg:px-[17px] lg:py-[25px] xl:py-10 bg-[#F6F6F6] !pb-[100px]  min-h-screen lg:flex lg:justify-center relative">
        ...
        <div class="lg:hidden mb-[30px] flex flex-col">
            <div class="back-button">
                <a href="{{ route('agent.car.list') }}" class="links_item_cta inline-flex py-1 px-2 border border-[#C8C0C0] rounded-md bg-[#fff] hover:border-[#F3CD0E] active:border-[#000] active:bg-[#F3CD0E]">
                    <img  class="w-[15px]" src="{{ asset('images/short_arrow.svg') }}">
        ...
        <div class="max-w-[768px] w-full bg-white lg:bg-[#F6F6F6] rounded-[10px] px-12  lg:px-[0px] py-9 lg:py-[0px]">
            <div class="booking_section">
                                ...
                                <div class="main_car_image_container w-1/3 sm:w-1/2 md:mb-2.5 px-2.5 py-2.5">
                                    <div class=" rounded-[12px]  ">
                                        ...
                                        <div class="booking_inner_bb logo_image w-full h-full flex flex-col items-center justify-center overflow-hidden ">
                                            ...
                                            <!-- <img class="p-[10px] block w-full main_img imageProfileUrl cursor-pointer toZoom"
                                                src="{{$modifiedImgUrl}}" alt="img">
                    ...
                    {{-- basic information  --}}
                    @if( (Helper::getUserMeta($partnerId, 'company_name')) ||  ($car->name) || ($car->registration_number) || ($car->car_type) || ($car->fuel_type)  || ($car->manufacturing_year) || ($car->price) || ($car->transmission) || ($car->roof_type) || (Helper::getCarMeta($car->id, 'plate_type')) )
                        ...
                        <div class="basic_information_sec pb-[15px]">
                            ...
                            <!-- Partner Name -->
                            @if(!empty(Helper::getUserMeta($partnerId, 'company_name')))
                                <div class="basic_information_sec_inner owner_name_left_sec justify-center  flex py-[14px]">
                                    <div class="basic_information_sec_left w-1/2 flex items-center text-base md:text-sm">
                                        <p class="capitalize whitespace-normal break-all">Partner Name:</p>
                                    </div>
                                    <div class="basic_information_sec_right car_name_right_sec w-1/2 pl-2 flex items-center text-base md:text-sm">
                                        <p class="capitalize whitespace-normal break-all">{{ Helper::getUserMeta($partnerId, 'company_name') }}</p>
                                    </div>
