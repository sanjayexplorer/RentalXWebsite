...
<head>
  ...
  <script src="{{asset('js/common.js'.generateRandomVersion())}}"></script>
  ...
  .list_content{ display: block; padding: 3px 60px!important; font-family: 'Roboto', sans-serif;  }
  /* for scroll problem in autocomplete */
  li.ui-menu-item { width: 99.5%; }
  /* .mob_autocomplete_ul{ padding: 0 55px;} */
  /* end */
  /* .link_listing_hov:hover { background-color: #f7df67; } */
  /* For Sidebar Fixed  */
  .sidebar{ width:260px; }
  ...
  /* .notification_bar_open .sidebar ,.notification_bar_open .main_header_container ,.notification_bar_open .navigation {z-index: -1;} */
  ...
  .notification_bar{scrollbar-width: thin; scrollbar-color: #CCCCCC #fff;}
  .tab_active_a{text-decoration: underline;}
...
<body class="relative text-siteFont">
...
<div class="fixed top-0 left-0 z-[1000] flex items-center justify-center hidden w-full h-screen loader">
  ...
  <!--  -->
      ...
      <div class="sidebar xsm:w-[83%] lg:w-[90%] md:w-[83%] lg:fixed sticky z-[11] h-screen top-0 xsm:left-[-400px]
      md:left-[-675px] lg:left-[-950px] sm:left-[-400px] overflow-hidden lg:overflow-y-scroll bg-[#FFFFFF]
       xl:w-[20%] w-[16%] 3xl:w-[18%] 2xl:w-[20%]">
        <div class="website_logo_sec items-center lg:hidden border-b flex justify-center py-[20px] px-[25px] xsm:hidden:border-r border-[#DAD8D8] afclr !h-[65px] !min-h-[65px]">
          <div class="logo">
            <a href="{{route('partner.booking.list')}}" class="links_item_cta"><img class="w-full h-[45px]"
        ...
        <div class="relative border-r border-[#DAD8D8] h-full">
          ...
          <div class="items-center px-5 pt-8 user_info_deatils hidden lg:flex afclr">
            <div class="logo ">
              <a href="{{route('partner.booking.list')}}" class="links_item_cta" ><img class="w-full" src="{{asset('images/logo.svg')}}" alt=""></a>
            </div>
          </div>
          <div class="sidebar_l relative">
            <div
              ...
              <ul class="layout_sidebar_listing list-none 2xl:pt-[0px] pt-[15px] afclr">
                ...
                <li class="relative mb-[40px] 3xl:mb-[35px] align-middle link_listing @if(strcmp($controller, 'BookingController') == 0) @else active  @endif">
                  ...
                  <a href="javascript:void(0)" class="user_info_sec_top relative transition-all duration-300 ease-out text-black text-lg 2xl:leading-[18px] 2xl:text-base font-normal flex items-center py-[10px] px-[11px] lg:px-[20px] rounded-lg lg:rounded-l-none min-h-[45px] list_item_link
                  ...
                  @if (strcmp($controller, 'BookingController') == 0) block  @else hidden  @endif">
                      <div class=" 2xl:pl-[25px] lg:pl-[35px]">
                        ...
                        <div class="active_bookings ">
                          ...
                          @if (strcmp($controllerAction, 'BookingController@list') == 0) text-[#fff] bg-[#F3CD0E]  rounded-lg @else  @endif block pl-[15px] pr-[10px] py-[10px] rounded-lg">
                          Active Bookings
                          </a>
                        </div>

                        <div class="all_bookings ">
                            <a href="{{route('partner.booking.allBookings')}}" class=" links_item_cta
                            @if (strcmp($controllerAction, 'BookingController@allBookings') == 0) text-[#fff] bg-[#F3CD0E] py-[10px] px-[20px] rounded-lg @else  @endif block pl-[15px] pr-[10px] py-[10px] rounded-lg">
                            All Bookings
                            </a>
                        </div>
                ...
                <li class="relative mb-[40px] 3xl:mb-[35px] align-middle link_listing ">
                    <a href="{{route('partner.car.list')}}"
                    class="links_item_cta @if (strcmp($controller, 'CarsController') == 0) bg-[#F3CD0E] @else bg-[#fff] @endif  hover:bg-[#F3CD0E] transition-all duration-300 ease-out text-black text-lg 2xl:text-base font-normal flex items-center py-[10px] px-[11px] lg:px-[20px] rounded-lg lg:rounded-l-none min-h-[45px] list_item_link">
                    <span class="svg_mob 2xl:w-[41px]  w-[45px] flex items-center relative top-[-2px] pt-[3px] pr-[10px]">
                ...
                <li class="relative mb-[40px] 3xl:mb-[35px] align-middle link_listing ">
                  <a href="{{route('partner.agent.list')}}"
                    class="links_item_cta @if (strcmp($controller, 'AgentController') == 0) bg-[#F3CD0E] @else bg-[#fff] @endif hover:bg-[#F3CD0E] transition-all duration-300 ease-out text-black text-lg 2xl:text-base font-normal flex items-center py-[10px] px-[11px] lg:px-[20px] rounded-lg lg:rounded-l-none min-h-[45px] list_item_link">
                    <span class="svg_mob 2xl:w-[41px]  w-[45px] flex items-center relative top-[-2px] pt-[3px] pr-[10px]">
                ...
                <li class="relative mb-[40px] 3xl:mb-[35px] align-middle link_listing ">
                  <a href="{{route('partner.users.list')}}"
                    ...
                    <span class="svg_mob 2xl:w-[41px]  w-[45px] flex items-center relative top-[-2px] pt-[3px] pr-[10px]">
                      <svg width="37" height="20" viewBox="0 0 37 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="18.9922" cy="7.73974" r="3.88085" stroke="black"/>
                        <circle cx="9.06249" cy="5.16308" r="3.88085" stroke="black"/>
                        <circle cx="3.88085" cy="3.88085" r="3.88085" transform="matrix(-1 0 0 1 32.6152 0.679932)" stroke="black"/>
                        <path d="M25.4708 18.5703H12.5128C12.7545 14.969 15.5866 12.1685 18.9918 12.1685C22.3971 12.1685 25.2292 14.969 25.4708 18.5703Z" stroke="black"/>
                        <path d="M12.8794 16.7663C7.41538 16.7663 1.31836 16.773 1.31836 16.773C1.31836 12.685 4.45046 9.37109 8.31409 9.37109C10.7145 9.37109 12.8325 10.6502 14.0925 12.5993C14.2589 12.8567 14.5292 13.376 14.6683 13.665" stroke="black"/>
                        <path d="M24.6616 16.4391C30.1256 16.4391 36.2227 16.4458 36.2227 16.4458C36.2227 12.3579 33.0906 9.04395 29.2269 9.04395C26.8266 9.04395 24.7086 10.323 23.4486 12.2722C23.2822 12.5296 23.0118 13.0488 22.8727 13.3378" stroke="black"/>
                        </svg>
      ...
      <div class="layout_main_sec xl:w-[80%] lg:w-[100%]  3xl:w-[82%] 2xl:w-[80%] w-[84%] relative afclr">

        <div class="right_dashboard_section">

          <div class="main_header_container lg:custom-shadow flex items-center justify-between py-[8px] px-9 border-b border-[#DAD8D8] lg:px-[17px] lg:border-none !h-[65px] !min-h-[65px]">
            ...
            <!-- notification icon ends  -->
                ...
                <div class="icons px-3">
                  <div class="list_items_popup_container relative flex justify-center items-center">
                    ...
                    <div
                      class="dots_hover_sec list_link_frame_section add_new_sec_links_container header_act_container lg:top-[47px] top-[52px] absolute md:w-[250px] w-[250px] border border-[#D1D1D1] rounded-[5px] py-[20px] sm:py-[10px] bg-[#fff] z-[2] right-0 custom-shadow afclr hidden">
                      <ul class="frame_list_items_popup">
                        <li class="relative align-middle link_listing border-b border-[#DAD8D8]">
                          <a href="{{route('partner.leads.add')}}"
                        ...
                        <li class="relative align-middle link_listing border-b border-[#DAD8D8]">
                          <a href="{{route('partner.booking.calendar')}}"
                            class="links_item_cta   bg-[#fff] hover:bg-[#F3CD0E] transition-all duration-300 ease-out text-black text-lg 2xl:text-base sm:text-sm font-normal flex items-center py-[8px] px-[11px] lg:px-[20px] min-h-[45px] list_item_link">
                            <span class="svg_mob 2xl:w-[35px] w-[41px] flex items-center relative top-[-2px] pt-[3px] pr-[10px]">
                              <svg width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <li class="relative align-middle link_listing border-b border-[#DAD8D8]">
                          <a href="{{route('partner.car.add')}}"
                            class="links_item_cta  bg-[#fff] hover:bg-[#F3CD0E] transition-all duration-300 ease-out text-black text-lg 2xl:text-base sm:text-sm font-normal flex items-center py-[8px] px-[11px] lg:px-[20px] min-h-[45px] list_item_link">
                            <span class="svg_mob 2xl:w-[41px]  w-[45px] flex items-center relative top-[-2px] pt-[3px] pr-[10px]">
                              <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                  d="M18.7107 6.18258C18.0735 3.91568 18.058 3.73371 17.6069 2.08997C17.4398 1.48209 16.8945 1.05494 16.2645 1.03429L11.4791 0.87793L6.6258 1.03656C6.03217 1.05598 5.5067 1.43665 5.32163 2.00095C4.74804 3.74982 4.85896 3.96278 4.03564 6.27182"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M21.5078 11.035V10.8572C21.5078 8.7931 21.5078 7.76117 20.9131 7.11012C20.3185 6.45928 19.2512 6.36261 17.1165 6.16949C14.8168 5.96128 12.851 5.72375 11.5755 5.71218C10.4732 5.70227 7.5889 5.96851 5.17637 6.21472C3.49876 6.38595 2.65996 6.47147 2.09958 6.99797C2.02254 7.07026 1.94901 7.14978 1.88291 7.23219C1.40185 7.83181 1.38182 8.6826 1.34175 10.3844C1.29527 12.3538 1.27214 13.3385 1.82012 13.9943C1.89551 14.0843 1.97772 14.1686 2.06592 14.2461C2.7087 14.8095 3.69375 14.8095 5.66363 14.8095H6.93371"
                                  stroke="black" stroke-width="0.8"></path>
                                <path d="M1.9834 12.207H9.80509" stroke="black" stroke-width="0.8" stroke-linecap="round"></path>
                                <path
                                  d="M15.3747 10.593C15.2685 10.139 15.1848 9.78146 15.1204 9.5055C15.0111 9.03808 14.5945 8.70801 14.1145 8.70801H8.68012C8.19534 8.70801 7.77604 9.04427 7.67153 9.51769C7.50566 10.2685 7.25512 11.4019 7.05518 12.2993"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M1.36182 11.7495V15.4462C1.36182 15.9024 1.73175 16.2724 2.18802 16.2724H4.27688C4.73315 16.2724 5.10308 15.9024 5.10308 15.4462V12.2122"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M18.2256 4.86328H19.9127C20.369 4.86328 20.7389 5.23321 20.7389 5.68949V6.29675C20.7389 6.54089 20.5726 6.75343 20.3357 6.8123"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M4.4022 4.86328H2.71488C2.25861 4.86328 1.88867 5.23321 1.88867 5.68949V6.52148C1.88867 6.73051 2.09357 6.87819 2.29186 6.81209"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M4.39855 8.61768H4.5357C4.97111 8.61768 5.3239 8.97067 5.3239 9.40588C5.3239 9.84129 4.97091 10.1941 4.5357 10.1941H4.39855C3.96314 10.1941 3.61035 9.84108 3.61035 9.40588C3.61035 8.97067 3.96335 8.61768 4.39855 8.61768Z"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M18.2091 8.61768H18.3462C18.7817 8.61768 19.1345 8.97067 19.1345 9.40588C19.1345 9.84129 18.7815 10.1941 18.3462 10.1941H18.2091C17.7737 10.1941 17.4209 9.84108 17.4209 9.40588C17.4207 8.97067 17.7737 8.61768 18.2091 8.61768Z"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M23.4256 15.9121C22.7883 13.6452 22.7729 13.4632 22.3215 11.8195C22.1546 11.2116 21.6094 10.7844 20.9794 10.7638L16.194 10.6074L11.3406 10.7661C10.747 10.7855 10.2215 11.1661 10.0365 11.7304C9.46288 13.4793 9.5738 13.6923 8.75049 16.0013"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M21.6973 24.1883H10.5394C9.4348 24.1883 8.64804 24.1874 8.05235 24.1067C7.46843 24.0274 7.13175 23.8786 6.8876 23.6291C6.64346 23.3796 6.50218 23.0398 6.43608 22.4543C6.36854 21.8567 6.38506 21.0704 6.40944 19.9659L6.41295 19.8085C6.43401 18.8572 6.44971 18.183 6.52758 17.6662C6.60359 17.1614 6.73248 16.8588 6.94523 16.627C7.1586 16.3945 7.44736 16.2408 7.93854 16.1224C8.44211 16.0012 9.10555 15.9285 10.0427 15.8271C12.4319 15.5685 15.1811 15.3014 16.2279 15.3113C17.1224 15.32 18.3622 15.4497 19.8452 15.605C20.4636 15.6697 21.1246 15.7389 21.8204 15.8056C22.877 15.9068 23.6329 15.9799 24.2001 16.1026C24.7609 16.2238 25.0734 16.3817 25.2841 16.608C25.2882 16.6124 25.2918 16.6163 25.2959 16.6208C25.5066 16.8516 25.6369 17.168 25.7117 17.7123C25.7875 18.2654 25.7986 18.9923 25.8135 20.0118C25.8294 21.1016 25.8397 21.8774 25.7693 22.4669C25.7001 23.0448 25.5592 23.3807 25.3186 23.6273C25.3143 23.6318 25.3099 23.6364 25.3054 23.6407C25.0623 23.885 24.7285 24.0307 24.1516 24.1081C23.5631 24.1874 22.7873 24.1883 21.6973 24.1883Z"
                                  stroke="black" stroke-width="0.8"></path>
                                <path d="M6.69873 21.936H25.6238" stroke="black" stroke-width="0.8" stroke-linecap="round"></path>
                                <path
                                  d="M20.4892 22.0283L19.8354 19.2345C19.7262 18.7675 19.3096 18.437 18.83 18.437H13.395C12.9104 18.437 12.4909 18.7733 12.3864 19.2467C12.2205 19.9975 11.97 21.1309 11.77 22.0283"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M6.38916 21.6997V25.1753C6.38916 25.6316 6.75909 26.0016 7.21537 26.0016H9.37486C9.83113 26.0016 10.2011 25.6316 10.2011 25.1753V21.6997"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M22.0586 21.7024V25.1753C22.0586 25.6316 22.4285 26.0015 22.8848 26.0015H24.9854C25.4417 26.0015 25.8116 25.6316 25.8116 25.1753V21.5923"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M23.0063 14.4878H24.6937C25.1499 14.4878 25.5199 14.8577 25.5199 15.314V16.146C25.5199 16.355 25.315 16.5027 25.1165 16.4366"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M9.18226 14.4878H7.49515C7.03888 14.4878 6.66895 14.8577 6.66895 15.314V16.146C6.66895 16.355 6.87384 16.5027 7.07213 16.4366"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M9.11388 18.3467H9.25103C9.68644 18.3467 10.0392 18.6997 10.0392 19.1349C10.0392 19.5703 9.68624 19.9231 9.25103 19.9231H9.11388C8.67847 19.9231 8.32568 19.5701 8.32568 19.1349C8.32568 18.6997 8.67847 18.3467 9.11388 18.3467Z"
                                  stroke="black" stroke-width="0.8"></path>
                                <path
                                  d="M22.9239 18.3467H23.0611C23.4965 18.3467 23.8493 18.6997 23.8493 19.1349C23.8493 19.5703 23.4963 19.9231 23.0611 19.9231H22.9239C22.4885 19.9231 22.1357 19.5701 22.1357 19.1349C22.1357 18.6997 22.4887 18.3467 22.9239 18.3467Z"
                                  stroke="black" stroke-width="0.8"></path>
                              </svg>
                            </span>
                            Add Car
                        ...
                        <li class="relative align-middle link_listing border-b border-[#DAD8D8]">
                          <a href="{{route('partner.agent.add')}}"
                            ...
                            <span class="svg_mob 2xl:w-[41px]  w-[45px] flex items-center relative top-[-2px] pt-[3px] pr-[10px]">
                              <svg width="26" height="20" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="18.5337" cy="7.68359" r="3.88085" stroke="black"></circle>
                                <circle cx="7.95703" cy="4.50488" r="3.88085" stroke="black"></circle>
                                <path
                                  d="M25.0128 18.5146H12.0548C12.2965 14.9133 15.1286 12.1128 18.5338 12.1128C21.939 12.1128 24.7712 14.9133 25.0128 18.5146Z"
                                  stroke="black"></path>
                                <path
                                  d="M12.4214 16.7101C6.95737 16.7101 0.860352 16.7168 0.860352 16.7168C0.860352 12.6289 3.99245 9.31494 7.85608 9.31494C10.2564 9.31494 12.3744 10.594 13.6344 12.5432C13.8009 12.8006 14.0712 13.3198 14.2103 13.6088"
                                  stroke="black"></path>
                              </svg>
                            </span>
                            Invite Agent
                        ...
                        <li class="relative align-middle link_listing ">
                          <a href="{{route('partner.users.add')}}"
                            class="links_item_cta  bg-[#fff] hover:bg-[#F3CD0E] transition-all duration-300 ease-out text-black text-lg 2xl:text-base sm:text-sm font-normal flex items-center py-[8px] px-[11px] lg:px-[20px] min-h-[45px] list_item_link">
                            <span class="svg_mob 2xl:w-[41px]  w-[45px] flex items-center relative top-[-2px] pt-[3px] pr-[10px]">
                              <svg width="37" height="20" viewBox="0 0 37 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="18.9922" cy="7.73974" r="3.88085" stroke="black"></circle>
                                <circle cx="9.06249" cy="5.16308" r="3.88085" stroke="black"></circle>
                                <circle cx="3.88085" cy="3.88085" r="3.88085" transform="matrix(-1 0 0 1 32.6152 0.679932)"
                                  stroke="black"></circle>
                                <path
                                  d="M25.4708 18.5703H12.5128C12.7545 14.969 15.5866 12.1685 18.9918 12.1685C22.3971 12.1685 25.2292 14.969 25.4708 18.5703Z"
                                  stroke="black"></path>
                                <path
                                  d="M12.8794 16.7663C7.41538 16.7663 1.31836 16.773 1.31836 16.773C1.31836 12.685 4.45046 9.37109 8.31409 9.37109C10.7145 9.37109 12.8325 10.6502 14.0925 12.5993C14.2589 12.8567 14.5292 13.376 14.6683 13.665"
                                  stroke="black"></path>
                                <path
                                  d="M24.6616 16.4391C30.1256 16.4391 36.2227 16.4458 36.2227 16.4458C36.2227 12.3579 33.0906 9.04395 29.2269 9.04395C26.8266 9.04395 24.7086 10.323 23.4486 12.2722C23.2822 12.5296 23.0118 13.0488 22.8727 13.3378"
                                  stroke="black"></path>
                              </svg>
                            </span>
                            Add User
                ...
                <div class="icons px-3">
                  <div class="list_items_popup_container flex justify-center items-center relative">
                    <a href="javascript:void(0);" class="rounded-[4px]
                    ...
                    <div
                      class="  dots_hover_sec list_link_frame_section profile_sec_container header_act_container  top-[51px] lg:top-[43px] absolute md:w-[280px] w-[280px] border border-[#D1D1D1] rounded-[5px]  bg-[#fff] z-[2] right-2 custom-shadow afclr hidden">
                      <div class="user_info_details flex py-[30px] px-[20px] items-center ">
                        <div class="user_info_details_left_sec ">
                          <div class="user_profile_inner_sec w-[50px] h-[50px] mr-[10px]">
                            ...
                            <a href="javascript:void(0); "
                              class=" @if(strcmp($modifiedUrl, '') == 0) @else border border-[#D1D1D1] rounded-full p-[7px] @endif w-full h-full inline-flex items-center ">
                              <img
                                src="{{ strcmp($modifiedUrl, '') !== 0 ? $modifiedUrl : asset('images/small_avtar_img.jpg') }}"
                                alt="user icon">
                            </a>
                        ...
                        <div class="user_info_details_right_sec">
                          <h5 class="text-[14px] text-[#000] font-medium leading-[1.4] capitalize">
                            {{Helper::getUserMeta(auth()->user()->id, 'owner_name')}}</h5>
              ...
              <div class="relative hidden w-full search_sec lg:block">
                ...
                <!-- input field -->
                  <form class="flex " id="search-form" action="#" method="GET" autocomplete="off">
                    ...
                    class="search w-full capitalize text-sm outline-none  rounded-[10px] lg:border  lg:border-[#E4E4E4] pt-[15px] pr-[95px] pb-[15px] pl-[60px] sm:pl-[50px] sm:pr-[75px]"
                    placeholder="Search agent name/car name" autocomplete="off">
                  <div class="absolute close_desktop flex align-center right-[30px] top-0 bottom-0 hidden"
                ...
                <!-- Profile -->
                <div
                  class="input-group-append flex p-[10px] rounded-tl-0 rounded-tr-[10px] rounded-br-[10px] rounded-bl-0 ml-[10px] absolute top-0 bottom-0 right-[7px]">
                  <button href="{{ route('partner.search') }}" class="btn" type="submit">
    ...
    <!---->
        ...
        <div class="right_dashboard_section_inner lg:pb-5 xl:py-0 bg-[#F6F6F6]">
...
$(document).ready(function() {
  ...
  $('.active_bookings').on('click', function (e) {
      console.log("active_bookings is clicked");
      $('.all_bookings a').removeClass('text-[#fff] bg-[#F3CD0E]');
      $('.active_bookings a').addClass('text-[#fff] bg-[#F3CD0E]');
  });

  $('.all_bookings').on('click', function (e) {
    console.log("all_bookings is clicked");
    $('.active_bookings a').removeClass('text-[#fff] bg-[#F3CD0E]');
    $('.all_bookings a').addClass('text-[#fff] bg-[#F3CD0E]');
  });



var path = "{{ route('partner.autocomplete') }}";
$("#search").autocomplete({
    ...
    select: function(event, ui) {
        if ((ui.item.label != 'AGENTS') && (ui.item.label != 'CARS')) {
            $('#search').val(ui.item.label);
            window.location.href = "{{ route('partner.search') }}?id=" + ui.item.id + "&name=" + encodeURIComponent(ui.item.label) + "&header=" + encodeURIComponent(ui.item.header);
        }
        else {
        }
        return false;
...
.data("ui-autocomplete")._renderItem = function(ul, item) {
    if ((item.label == 'AGENTS' ) || (item.label == 'CARS' )) {
        return $("<li>")
            .append('<span class="list_title text-base font-medium leading-4 text-[#2B2B2B] ">' + item.label + '</span>')
            .appendTo(ul);
    } else {
        return $("<li>")
            .append('<span class="list_content text-sm font-medium leading-none text-[#272522] capitalize">' + item.label + (item.registration_number ? ' (' + item.registration_number + ')' : '') + '</span>')
            .appendTo(ul);
    }
};
