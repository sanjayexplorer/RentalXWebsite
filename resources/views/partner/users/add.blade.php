...
<div class="max-w-[768px] w-full bg-white lg:bg-[#F6F6F6] rounded-[10px] px-12  lg:px-[0px] py-9 lg:py-[0px]">
    <div class="booking_section">
        <form action="{{route('partner.users.add.post')}}" method="post" onsubmit="return validate()">
          @csrf
                ...
                <div class="flex flex-wrap -mx-3">
                    <div class="w-full px-3 sm:w-full inp_container">
                        ...
                        <input type="text" tabindex="-1" name="name" id="name"
                            ...
                            data-error-msg="Name is required" placeholder="Enter name" value="{{old('name')}}">
            ...
            <div class="pb-5">
                <div class="flex flex-wrap -mx-3">
                    <div class="w-full px-3 sm:w-full inp_container mobile_number mobile_number_container">
                        ...
                        <input type="tel" tabindex="-1" name="mobile_number" id="mobile_number" class="required_fields phone_validation w-full px-5 py-3 text-base font-normal leading-normal text-black bg-white border rounded-md border-black500 focus:outline-none focus:border-siteYellow" placeholder="Enter mobile number" data-error-msg="Mobile number is required"  value="{{old('mobile_number')}}">
            ...
            <div class="pb-5">
                <div class="flex flex-wrap -mx-3">
                    <div class="w-full px-3 sm:w-full inp_container">
                        ...
                        <select name="user_type" id="user_type" tabindex="-1"
