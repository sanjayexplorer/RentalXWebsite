...
.p_apply_btn{ display: block; }
.popup_header > h1{ font-size: 22px; }
    ...
    <div class="desktp_min_height py-9 px-9 lg:pt-[20px] lg:pb-[100px] lg:px-[17px] bg-[#F6F6F6]  ">
            ...
            <div class="flex items-center mb-[36px] lg:mb-[20px]">
                <div class="w-1/2 flex justify-start items-center">
                    <a href="#" class="hidden py-2 mr-2">
                        <img class="w-[42px]" src="{{asset('images/panel-back-arrow.svg')}}">
                    </a>
                    <span  class="inline-block text-black800 text-[26px] md:text-xl font-normal leading-normal align-middle">
                        Manage Cars
                    </span>
                </div>

                <div class="w-1/2 text-right ">
                    <a href="{{route('partner.car.add')}}" class="links_item_cta inline-flex rounded-[4px] items-center text-black text-base md:text-sm font-normal  bg-siteYellow px-[20px] py-2.5 md:px-[15px]"><img
                            class=" mr-[8px] w-[17px] relative md:top-[-0px] top-[-2px]"
                            src="{{asset('images/fa-add-icon.svg')}}" alt="">
                            ADD NEW CAR
                    </a>
                </div>
            </div>
            ...
            <div class="cars_mn_outer">
                ...
                <div class="cars_main_box flex flex-wrap -mx-4" id="cars-container">
                        ...
                        <div class="relative px-5 py-4 bg-white rounded-[9px]">
                                ...
                                <div class="absolute top-4 right-4">
                                    <a href="javascript:void(0);"
                                        ...
                                        data-delete-url="{{ route('partner.car.delete', $car->id) }}">
                                        <img src="{{ asset('images/delete_icon_red.svg') }}"
                                            class="delete_icon" alt="delete_icon">
                                    </a>
                                </div>
                                <div class="absolute bottom-4 right-4 ">
                                    <a href="{{ route('partner.car.edit', $car->id) }}"
                                        class="links_item_cta edit_btn flex items-center justify-center w-5 h-5">
                    ...
                    @include('partner.cars.load-more', ['initialCarIds' => $initialCars->pluck('id')->toArray()])
                </div>
...
$(document).ready(function ()
{
    ...
    function loadMoreCars()
    {
        ...
        loading = true;
        $.ajax({
            url: '{{ route('partner.cars.load-more') }}',
            type: 'GET',
            data: {
                page: page,
...
$('#add_car_btn').on('click',function()
{
    ...
    {
        var url = "{{route('partner.car.add', '')}}"+"/"+user_id;
