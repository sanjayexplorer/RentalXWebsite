...
@section('title', 'Edit booking - edit customer details')
@section('content')
@php
    $modifiedImgUrl = '';
@endphp
...
@php
    ...
    if(strcmp($car_booking->carId,'0')!==0){
        $car_name= Helper::getCarNameByCarId($car_booking->carId);
    }else{
      $car_name = $car_booking->car_name;
    }

    if(strcmp($car_booking->carId,'0')!==0){
      $registeration_number = Helper::getCarRagisterationNoByCarId($carId);
    }else{
      $registeration_number = $car_booking->registration_number;
    }
    ...
    <div class="dashboard_ct_section">
        <div class="lg:flex hidden lg:bg-white lg:mb-[0px] lg:px-[17px] lg:py-[15px] mb-[20px] justify-start items-center">
            <div class="flex items-center justify-start w-1/2">
                <a href="{{route('partner.booking.view',$car_booking->id)}}" class="links_item_cta inline-block p-2 mr-2 border border-[#C8C0C0] rounded-md hover:border-[#F3CD0E] active:border-[#000] active:bg-[#F3CD0E] ">
                    <img class="w-[15px]" src="{{ asset('images/short_arrow.svg') }}">
                </a>
                 <span class="inline-block sm:text-base sm:text-left text-xl font-normal leading-normal align-middle text-black800">Edit Booking</span>
            </div>
        </div>
            ...
            <div class="lg:hidden flex items-center mb-[36px] lg:mb-[20px]">
                ...
                <div class="lg:hidden flex flex-col">
                    <div class="back-button">
                        <a href="{{route('partner.booking.view',$car_booking->id)}}" class="links_item_cta inline-flex py-1 px-2 border border-[#C8C0C0] rounded-md bg-[#fff] hover:border-[#F3CD0E] active:border-[#000] active:bg-[#F3CD0E] GobackDelete">
                            <img  class="w-[15px]" src="{{ asset('images/short_arrow.svg') }}">
            ...
            <div class="max-w-[768px] w-full bg-white lg:bg-[#F6F6F6] rounded-[10px] px-12 lg:px-[0px] py-9 lg:py-[0px]">
                ...
                <h4 class="inline-block text-black800 text-[26px] lg:text-[24px] md:text-xl font-normal leading-normal align-middle capitalize ">
                                    ...
                                    <div class="flex booking_main_details_inner_top ">
                                     ...
                                     <div class="w-[55%] md:w-[50%] flex text-left booking_main_inner_right md:pl-[0px] pl-[15px] items-center">
                                        <div class="car_details ">
                                            <p class="capitalize sm:text-[13px] text-[#898376]">
                                                @if(strcmp($car_booking->carId,'0')!==0)
                                                {{$car->name}}
                                                @else
                                                {{$car_booking->car_name}}
                                                @endif
                                            </p>
                                            <p class="capitalize sm:text-[13px] text-[#898376]">
                                                  @if(strcmp($car_booking->carId,'0')!==0)
                                                    <span>{{$car->roof_type}}</span> -
                                                  @else
                                                    <span></span>
                                                  @endif
                                                 @if(strcmp($car_booking->carId,'0')!==0)
                                                 ...
                                                 <span></span>
                                                 @endif</p>
                                              <p class="capitalize sm:text-[13px] text-[#700D4A] font-bold registeration_no">
                                                @if(strcmp($car_booking->carId,'0')!==0)
                                                {{$car->registration_number}}
                                                @else
                                                {{$car_booking->registration_number}}
                                                @endif
                                        ...
                                        <div class="relative flex border border-[#898376] rounded-[10px] form_inner sm:bg-[#F6F6F6]">
                                            <div
                                                ...
                                                <h4
                                                    ...
                                                    FROM</h4>
                                            <div class="block">
                                                <h4 class="text-black font-medium leading-4 text-[14px] sm:text-[13px] mb-[3px]"><span class=""id="pickupDateTimeSec">{{$pickupFormattedDate}}, {{$car_booking->pickup_time}}</span></h4>
                                            </div>
                    ...
                    <a href="javascript:void(0);"  data-src="#open_popup"
                        ...
                        disabled:opacity-40 disabled:cursor-not-allowed uppercase">Edit Date Time
                    </a>
                </div>
          <form action="{{route('partner.edit.customer.details',$car_booking->id)}}" class="mt-5" id="formId" method="POST" onsubmit="return checkForm()">
            @csrf
            <input class="hidden" type="text" id="carId" name="carId" value="{{$carId}}">
             ...
             @if(strcmp($car_booking->booking_type,'external')!==0)
             <input class="hidden" type="text" name="car_name" value="{{$car_name}}">
             <input class="hidden" type="text" name="registeration_number" value="{{$registeration_number}}">
            <!---->
            @else
             <div class="pb-5">
            ...
            <div class="flex flex-wrap -mx-3">
                <div class="registration_number_container w-full px-3 sm:w-full inp_container">
                        ...
                        <div class="flex relative ">
                            ...
                            <input type="text" tabindex="-1" name="registeration_number" value="{{$registeration_number}}"
                  ...
                  <div class="flex flex-wrap -mx-3">
                    <div class="w-full px-3 sm:w-full inp_container">
                        <label for="customer_name" class="block pb-2.5 text-sm font-normal leading-4 text-left text-black">Customer name<span class="text-[#ff0000]">*</span></label>
                            <input id="customer_name" tabindex="-1" class="w-full px-5 py-3 text-base font-normal leading-normal text-black bg-white border  rounded-md required_field border-black500 focus:outline-none focus:border-siteYellow"   type="text"  name="customer_name"  placeholder="Enter customer name"
                            ...
                            <div class="pb-5">
                                <div class="flex flex-wrap -mx-3">
                                    <div class="w-full px-3 sm:w-full">
                                        ...
                                        <input id="customer_city" tabindex="-1"  class="w-full px-5 py-3 text-base font-normal leading-normal text-black bg-white border rounded-md border-black500 focus:outline-none focus:border-siteYellow"
                            ...
                            <div class="flex flex-wrap -mx-3">
                                ...
                                <div class="w-full px-3 sm:w-full inp_container">
                                    <label for="number_of_days" class="flex justify-between block pb-2.5 text-sm font-normal leading-4 text-left text-black">
                                        ...
                                        <p class="text-[#777777]">Suggested number of days: <span class="suggested_number_of_days">{{intval($car_booking->number_of_days)}}</span> days</p>
                                    </label>
                                    <input type="text" tabindex="-1" name="number_of_days" id="number_of_days"  class="required_field w-full px-5 py-3 text-base font-normal leading-normal text-black bg-white  border rounded-md border-black500 focus:outline-none focus:border-siteYellow"
                                    placeholder="Enter number of days"  data-error-msg="Number of days is required" value="{{$car_booking->number_of_days}}">
                                    <span class="hidden required text-sm"></span>
                        ...
                        <!-- pickup charges and drop-off charges-->
                            <div class="pb-5">
                                ...
                                <div class="rupee_price_field">
                                <input type="text" tabindex="-1" name="pickup_charges" id="pickup_charges"   class="amount_total w-full px-5 py-3 required_field text-base font-normal leading-normal text-black  bg-white border rounded-md  border-black500 focus:outline-none focus:border-siteYellow pl-[33px]"
                     ...
                     <div class="pb-5">
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <span class="hidden required text-sm ssss"></span>
                                      ...
                                      <label for="select_driver" class="block pb-2.5 text-sm font-normal leading-4 text-left text-black">Select driver (optional)</label>
                                         <select name="select_driver" id="select_driver"
                                           ...
                                           <option value="" selected disabled>Select driver</option>
                                            ...
                                            <option value="{{$item->id}}" @if($car_booking->driver_id == $item->id ) selected @endif>{{$item->driver_name}}</option>
                                            @endforeach
                                           </select>
                                       </div>
                                       </div>
    ...
    <div class="form_section_b modal custom_pick_drop_popup" id="open_popup">
        <div class="form_section_b_inner">
            <form method="post" id="car_popup_form" class="car_popup_form" autocomplete="off">
                ...
                <input type="hidden" name="" id="fancyBoxPickupText">
                <input type="hidden" name="" id="fancyBoxDropoffText">
...
<input type="hidden" name="" id="viewRoute" value="{{route('partner.booking.view',$car_booking->id)}}">
...
var day_gap = 1;
  ...
  $('.drop_save').on('click', function () {
        ...
        // here check both time should't be same
        if (date == date2) {
            ...
            if (result == true) {
                ...
                Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('partner.edit.booking.dates') }}",
                            type: 'POST',
                            data: {
                                '_token': '{{ csrf_token() }}',
                                'carDetails': details,
  ...
  function initializeDatepickers() {
        ...
        let pickup_Time=moment(pickup_date).format("hh:mm A");

        let dropoff_Time=moment(dropoff_date).format("hh:mm A");


        let pickup_MomentObj = moment(pickup_Time, "hh:mm A");
        let dropoff_MomentObj = moment(dropoff_Time, "hh:mm A");


        // Get the overlap day total minutes
        let pick_totalMinutes = pickup_MomentObj.hours() * 60 + pickup_MomentObj.minutes();
        let drop_totalMinutes = dropoff_MomentObj.hours() * 60 + dropoff_MomentObj.minutes();
    ...
    function getAllBookedAndLockedDates(carId) {
        ...
        $.ajax({
            url: "{{ route('partner.getAllBookedAndLockedWithTime') }}",
            method: "post",
            data: {
                'carId': car_id,
                'bookingId':bookingId,
    ...
    function checkLockedAndBooked(car_id, startDate,pickTime,  endDate, dropTime, action_type, callback) {
        ...
        $.ajax({
            url: "{{ route('partner.checkLockedAndBookedDates') }}",
            method: "post",
            data: {
                'startDate': startDate,
                'endDate': endDate,
...
$('#discount').on('keyup input', function () {
 ...
 $('#advance_booking_amount').on('keyup input', function () {
    console.log(parseFloat($('#due_at_delivery').val().replace(/,/g, '')));
        ...
        $('.overlay_sections').css("display", "block");
          var required_fields = $('.required_field');
           ...
           required_fields.each(function() {
            ...
            // console.warn('error message:',$(this).closest('.inp_container').find('.required').toggle() );
          ...
          if (parseFloat($('#advance_booking_amount').val().replace(/,/g, '')) > parseFloat($('#total_booking_amount').val().replace(/,/g, ''))) {
           ...
           if (!firstErrorElement) {
            ...
            console.log('advance_booking_amount  else part');
